{
  ...
  '#':: d.pkg(name='scheduledSparkApplication', url='', help='"ScheduledSparkApplication is the Schema for the scheduledsparkapplications API."'),
  ...
  '#new':: d.fn(help='new returns an instance of ScheduledSparkApplication', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sparkoperator.k8s.io/v1beta2',
    kind: 'ScheduledSparkApplication',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ScheduledSparkApplicationSpec defines the desired state of ScheduledSparkApplication."'),
  spec: {
    '#template':: d.obj(help='"Template is a template from which SparkApplication instances can be created."'),
    template: {
      '#batchSchedulerOptions':: d.obj(help='"BatchSchedulerOptions provides fine-grained control on how to batch scheduling."'),
      batchSchedulerOptions: {
        '#withPriorityClassName':: d.fn(help="\"PriorityClassName stands for the name of k8s PriorityClass resource, it's being used in Volcano batch scheduler.\"", args=[d.arg(name='priorityClassName', type=d.T.string)]),
        withPriorityClassName(priorityClassName): { spec+: { template+: { batchSchedulerOptions+: { priorityClassName: priorityClassName } } } },
        '#withQueue':: d.fn(help="\"Queue stands for the resource queue which the application belongs to, it's being used in Volcano batch scheduler.\"", args=[d.arg(name='queue', type=d.T.string)]),
        withQueue(queue): { spec+: { template+: { batchSchedulerOptions+: { queue: queue } } } },
        '#withResources':: d.fn(help='"Resources stands for the resource list custom request for. Usually it is used to define the lower-bound limit.\\nIf specified, volcano scheduler will consider it as the resources requested."', args=[d.arg(name='resources', type=d.T.object)]),
        withResources(resources): { spec+: { template+: { batchSchedulerOptions+: { resources: resources } } } },
        '#withResourcesMixin':: d.fn(help='"Resources stands for the resource list custom request for. Usually it is used to define the lower-bound limit.\\nIf specified, volcano scheduler will consider it as the resources requested."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resources', type=d.T.object)]),
        withResourcesMixin(resources): { spec+: { template+: { batchSchedulerOptions+: { resources+: resources } } } },
      },
      '#deps':: d.obj(help='"Deps captures all possible types of dependencies of a Spark application."'),
      deps: {
        '#withArchives':: d.fn(help='"Archives is a list of archives to be extracted into the working directory of each executor."', args=[d.arg(name='archives', type=d.T.array)]),
        withArchives(archives): { spec+: { template+: { deps+: { archives: if std.isArray(v=archives) then archives else [archives] } } } },
        '#withArchivesMixin':: d.fn(help='"Archives is a list of archives to be extracted into the working directory of each executor."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='archives', type=d.T.array)]),
        withArchivesMixin(archives): { spec+: { template+: { deps+: { archives+: if std.isArray(v=archives) then archives else [archives] } } } },
        '#withExcludePackages':: d.fn(help='"ExcludePackages is a list of \\"groupId:artifactId\\", to exclude while resolving the\\ndependencies provided in Packages to avoid dependency conflicts."', args=[d.arg(name='excludePackages', type=d.T.array)]),
        withExcludePackages(excludePackages): { spec+: { template+: { deps+: { excludePackages: if std.isArray(v=excludePackages) then excludePackages else [excludePackages] } } } },
        '#withExcludePackagesMixin':: d.fn(help='"ExcludePackages is a list of \\"groupId:artifactId\\", to exclude while resolving the\\ndependencies provided in Packages to avoid dependency conflicts."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='excludePackages', type=d.T.array)]),
        withExcludePackagesMixin(excludePackages): { spec+: { template+: { deps+: { excludePackages+: if std.isArray(v=excludePackages) then excludePackages else [excludePackages] } } } },
        '#withFiles':: d.fn(help='"Files is a list of files the Spark application depends on."', args=[d.arg(name='files', type=d.T.array)]),
        withFiles(files): { spec+: { template+: { deps+: { files: if std.isArray(v=files) then files else [files] } } } },
        '#withFilesMixin':: d.fn(help='"Files is a list of files the Spark application depends on."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='files', type=d.T.array)]),
        withFilesMixin(files): { spec+: { template+: { deps+: { files+: if std.isArray(v=files) then files else [files] } } } },
        '#withJars':: d.fn(help='"Jars is a list of JAR files the Spark application depends on."', args=[d.arg(name='jars', type=d.T.array)]),
        withJars(jars): { spec+: { template+: { deps+: { jars: if std.isArray(v=jars) then jars else [jars] } } } },
        '#withJarsMixin':: d.fn(help='"Jars is a list of JAR files the Spark application depends on."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='jars', type=d.T.array)]),
        withJarsMixin(jars): { spec+: { template+: { deps+: { jars+: if std.isArray(v=jars) then jars else [jars] } } } },
        '#withPackages':: d.fn(help='"Packages is a list of maven coordinates of jars to include on the driver and executor\\nclasspaths. This will search the local maven repo, then maven central and any additional\\nremote repositories given by the \\"repositories\\" option.\\nEach package should be of the form \\"groupId:artifactId:version\\"."', args=[d.arg(name='packages', type=d.T.array)]),
        withPackages(packages): { spec+: { template+: { deps+: { packages: if std.isArray(v=packages) then packages else [packages] } } } },
        '#withPackagesMixin':: d.fn(help='"Packages is a list of maven coordinates of jars to include on the driver and executor\\nclasspaths. This will search the local maven repo, then maven central and any additional\\nremote repositories given by the \\"repositories\\" option.\\nEach package should be of the form \\"groupId:artifactId:version\\"."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='packages', type=d.T.array)]),
        withPackagesMixin(packages): { spec+: { template+: { deps+: { packages+: if std.isArray(v=packages) then packages else [packages] } } } },
        '#withPyFiles':: d.fn(help='"PyFiles is a list of Python files the Spark application depends on."', args=[d.arg(name='pyFiles', type=d.T.array)]),
        withPyFiles(pyFiles): { spec+: { template+: { deps+: { pyFiles: if std.isArray(v=pyFiles) then pyFiles else [pyFiles] } } } },
        '#withPyFilesMixin':: d.fn(help='"PyFiles is a list of Python files the Spark application depends on."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='pyFiles', type=d.T.array)]),
        withPyFilesMixin(pyFiles): { spec+: { template+: { deps+: { pyFiles+: if std.isArray(v=pyFiles) then pyFiles else [pyFiles] } } } },
        '#withRepositories':: d.fn(help='"Repositories is a list of additional remote repositories to search for the maven coordinate\\ngiven with the \\"packages\\" option."', args=[d.arg(name='repositories', type=d.T.array)]),
        withRepositories(repositories): { spec+: { template+: { deps+: { repositories: if std.isArray(v=repositories) then repositories else [repositories] } } } },
        '#withRepositoriesMixin':: d.fn(help='"Repositories is a list of additional remote repositories to search for the maven coordinate\\ngiven with the \\"packages\\" option."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='repositories', type=d.T.array)]),
        withRepositoriesMixin(repositories): { spec+: { template+: { deps+: { repositories+: if std.isArray(v=repositories) then repositories else [repositories] } } } },
      },
      '#driver':: d.obj(help='"Driver is the driver specification."'),
      driver: {
        '#affinity':: d.obj(help='"Affinity specifies the affinity/anti-affinity settings for the pod."'),
        affinity: {
          ...
          nodeAffinity: {
            ...
            requiredDuringSchedulingIgnoredDuringExecution: {
              ...
              withNodeSelectorTerms(nodeSelectorTerms): { spec+: { template+: { driver+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } } },
              ...
              withNodeSelectorTermsMixin(nodeSelectorTerms): { spec+: { template+: { driver+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms+: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } } },
            },
            ...
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { driver+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
          ...
          podAffinity: {
            ...
            '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { driver+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { driver+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            ...
            withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { driver+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
            ...
            withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { driver+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
          ...
          podAntiAffinity: {
            ...
            '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe anti-affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling anti-affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { driver+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe anti-affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling anti-affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { driver+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            ...
            withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { driver+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
            ...
            withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { driver+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
        },
        '#configMaps':: d.obj(help='"ConfigMaps carries information of other ConfigMaps to add to the pod."'),
        configMaps: {
        ...
        '#dnsConfig':: d.obj(help='"DnsConfig dns settings for the pod, following the Kubernetes specifications."'),
        dnsConfig: {
          ...
          withNameservers(nameservers): { spec+: { template+: { driver+: { dnsConfig+: { nameservers: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } } },
          ...
          withNameserversMixin(nameservers): { spec+: { template+: { driver+: { dnsConfig+: { nameservers+: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } } },
          ...
          withOptions(options): { spec+: { template+: { driver+: { dnsConfig+: { options: if std.isArray(v=options) then options else [options] } } } } },
          ...
          withOptionsMixin(options): { spec+: { template+: { driver+: { dnsConfig+: { options+: if std.isArray(v=options) then options else [options] } } } } },
          ...
          withSearches(searches): { spec+: { template+: { driver+: { dnsConfig+: { searches: if std.isArray(v=searches) then searches else [searches] } } } } },
          ...
          withSearchesMixin(searches): { spec+: { template+: { driver+: { dnsConfig+: { searches+: if std.isArray(v=searches) then searches else [searches] } } } } },
        },
        '#env':: d.obj(help='"Env carries the environment variables to add to the pod."'),
        env: {
        ...
        '#envFrom':: d.obj(help='"EnvFrom is a list of sources to populate environment variables in the container."'),
        envFrom: {
        ...
        '#gpu':: d.obj(help='"GPU specifies GPU requirement for the pod."'),
        gpu: {
          '#withName':: d.fn(help='"Name is GPU resource name, such as: nvidia.com/gpu or amd.com/gpu"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { template+: { driver+: { gpu+: { name: name } } } } },
          '#withQuantity':: d.fn(help='"Quantity is the number of GPUs to request for driver or executor."', args=[d.arg(name='quantity', type=d.T.integer)]),
          withQuantity(quantity): { spec+: { template+: { driver+: { gpu+: { quantity: quantity } } } } },
        },
        '#hostAliases':: d.obj(help='"HostAliases settings for the pod, following the Kubernetes specifications."'),
        hostAliases: {
        ...
        '#initContainers':: d.obj(help='"InitContainers is a list of init-containers that run to completion before the main Spark container."'),
        initContainers: {
        ...
        '#lifecycle':: d.obj(help='"Lifecycle for running preStop or postStart commands"'),
        lifecycle: {
          '#postStart':: d.obj(help='"PostStart is called immediately after a container is created. If the handler fails,\\nthe container is terminated and restarted according to its restart policy.\\nOther management of the container blocks until the hook completes.\\nMore info: https://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/#container-hooks"'),
          postStart: {
            '#exec':: d.obj(help='"Exec specifies a command to execute in the container."'),
            exec: {
              '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
              withCommand(command): { spec+: { template+: { driver+: { lifecycle+: { postStart+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } } },
              '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
              withCommandMixin(command): { spec+: { template+: { driver+: { lifecycle+: { postStart+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } } },
            },
            '#httpGet':: d.obj(help='"HTTPGet specifies an HTTP GET request to perform."'),
            httpGet: {
              '#httpHeaders':: d.obj(help='"Custom headers to set in the request. HTTP allows repeated headers."'),
              ...
              '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set\\n\\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
              withHost(host): { spec+: { template+: { driver+: { lifecycle+: { postStart+: { httpGet+: { host: host } } } } } } },
              '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
              withHttpHeaders(httpHeaders): { spec+: { template+: { driver+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } } },
              '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
              withHttpHeadersMixin(httpHeaders): { spec+: { template+: { driver+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } } },
              '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
              withPath(path): { spec+: { template+: { driver+: { lifecycle+: { postStart+: { httpGet+: { path: path } } } } } } },
              '#withPort':: d.fn(help='"Name or number of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
              withPort(port): { spec+: { template+: { driver+: { lifecycle+: { postStart+: { httpGet+: { port: port } } } } } } },
              '#withScheme':: d.fn(help='"Scheme to use for connecting to the host.\\nDefaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
              withScheme(scheme): { spec+: { template+: { driver+: { lifecycle+: { postStart+: { httpGet+: { scheme: scheme } } } } } } },
            },
            '#sleep':: d.obj(help='"Sleep represents a duration that the container should sleep."'),
            sleep: {
              '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
              withSeconds(seconds): { spec+: { template+: { driver+: { lifecycle+: { postStart+: { sleep+: { seconds: seconds } } } } } } },
            },
            '#tcpSocket':: d.obj(help='"Deprecated. TCPSocket is NOT supported as a LifecycleHandler and kept\\nfor backward compatibility. There is no validation of this field and\\nlifecycle hooks will fail at runtime when it is specified."'),
            tcpSocket: {
              '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
              withHost(host): { spec+: { template+: { driver+: { lifecycle+: { postStart+: { tcpSocket+: { host: host } } } } } } },
              '#withPort':: d.fn(help='"Number or name of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
              withPort(port): { spec+: { template+: { driver+: { lifecycle+: { postStart+: { tcpSocket+: { port: port } } } } } } },
            },
          },
          '#preStop':: d.obj(help="\"PreStop is called immediately before a container is terminated due to an\\nAPI request or management event such as liveness/startup probe failure,\\npreemption, resource contention, etc. The handler is not called if the\\ncontainer crashes or exits. The Pod's termination grace period countdown begins before the\\nPreStop hook is executed. Regardless of the outcome of the handler, the\\ncontainer will eventually terminate within the Pod's termination grace\\nperiod (unless delayed by finalizers). Other management of the container blocks until the hook completes\\nor until the termination grace period is reached.\\nMore info: https://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/#container-hooks\""),
          preStop: {
            ...
            exec: {
              '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
              withCommand(command): { spec+: { template+: { driver+: { lifecycle+: { preStop+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } } },
              '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
              withCommandMixin(command): { spec+: { template+: { driver+: { lifecycle+: { preStop+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } } },
            },
            '#httpGet':: d.obj(help='"HTTPGet specifies an HTTP GET request to perform."'),
            httpGet: {
              '#httpHeaders':: d.obj(help='"Custom headers to set in the request. HTTP allows repeated headers."'),
              ...
              '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set\\n\\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
              withHost(host): { spec+: { template+: { driver+: { lifecycle+: { preStop+: { httpGet+: { host: host } } } } } } },
              '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
              withHttpHeaders(httpHeaders): { spec+: { template+: { driver+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } } },
              '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
              withHttpHeadersMixin(httpHeaders): { spec+: { template+: { driver+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } } },
              '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
              withPath(path): { spec+: { template+: { driver+: { lifecycle+: { preStop+: { httpGet+: { path: path } } } } } } },
              '#withPort':: d.fn(help='"Name or number of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
              withPort(port): { spec+: { template+: { driver+: { lifecycle+: { preStop+: { httpGet+: { port: port } } } } } } },
              '#withScheme':: d.fn(help='"Scheme to use for connecting to the host.\\nDefaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
              withScheme(scheme): { spec+: { template+: { driver+: { lifecycle+: { preStop+: { httpGet+: { scheme: scheme } } } } } } },
            },
            '#sleep':: d.obj(help='"Sleep represents a duration that the container should sleep."'),
            sleep: {
              '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
              withSeconds(seconds): { spec+: { template+: { driver+: { lifecycle+: { preStop+: { sleep+: { seconds: seconds } } } } } } },
            },
            '#tcpSocket':: d.obj(help='"Deprecated. TCPSocket is NOT supported as a LifecycleHandler and kept\\nfor backward compatibility. There is no validation of this field and\\nlifecycle hooks will fail at runtime when it is specified."'),
            tcpSocket: {
              '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
              withHost(host): { spec+: { template+: { driver+: { lifecycle+: { preStop+: { tcpSocket+: { host: host } } } } } } },
              '#withPort':: d.fn(help='"Number or name of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
              withPort(port): { spec+: { template+: { driver+: { lifecycle+: { preStop+: { tcpSocket+: { port: port } } } } } } },
            },
          },
        },
        '#podSecurityContext':: d.obj(help='"PodSecurityContext specifies the PodSecurityContext to apply."'),
        podSecurityContext: {
          '#appArmorProfile':: d.obj(help='"appArmorProfile is the AppArmor options to use by the containers in this pod.\\nNote that this field cannot be set when spec.os.name is windows."'),
          appArmorProfile: {
            '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used.\\nThe profile must be preconfigured on the node to work.\\nMust match the loaded name of the profile.\\nMust be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { template+: { driver+: { podSecurityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied.\\nValid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { driver+: { podSecurityContext+: { appArmorProfile+: { type: type } } } } } },
          },
          '#seLinuxOptions':: d.obj(help='"The SELinux context to be applied to all containers.\\nIf unspecified, the container runtime will allocate a random SELinux context for each\\ncontainer.  May also be set in SecurityContext.  If set in\\nboth SecurityContext and PodSecurityContext, the value specified in SecurityContext\\ntakes precedence for that container.\\nNote that this field cannot be set when spec.os.name is windows."'),
          seLinuxOptions: {
            '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
            withLevel(level): { spec+: { template+: { driver+: { podSecurityContext+: { seLinuxOptions+: { level: level } } } } } },
            '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
            withRole(role): { spec+: { template+: { driver+: { podSecurityContext+: { seLinuxOptions+: { role: role } } } } } },
            '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { driver+: { podSecurityContext+: { seLinuxOptions+: { type: type } } } } } },
            '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
            withUser(user): { spec+: { template+: { driver+: { podSecurityContext+: { seLinuxOptions+: { user: user } } } } } },
          },
          '#seccompProfile':: d.obj(help='"The seccomp options to use by the containers in this pod.\\nNote that this field cannot be set when spec.os.name is windows."'),
          seccompProfile: {
            '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used.\\nThe profile must be preconfigured on the node to work.\\nMust be a descending path, relative to the kubelet's configured seccomp profile location.\\nMust be set if type is \\\"Localhost\\\". Must NOT be set for any other type.\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { template+: { driver+: { podSecurityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied.\\nValid options are:\\n\\nLocalhost - a profile defined in a file on the node should be used.\\nRuntimeDefault - the container runtime default profile should be used.\\nUnconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { driver+: { podSecurityContext+: { seccompProfile+: { type: type } } } } } },
          },
          ...
          windowsOptions: {
            '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook\\n(https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the\\nGMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
            withGmsaCredentialSpec(gmsaCredentialSpec): { spec+: { template+: { driver+: { podSecurityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } } },
            '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
            withGmsaCredentialSpecName(gmsaCredentialSpecName): { spec+: { template+: { driver+: { podSecurityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } } },
            '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container.\\nAll of a Pod's containers must have the same effective HostProcess value\\n(it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).\\nIn addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
            withHostProcess(hostProcess): { spec+: { template+: { driver+: { podSecurityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } } },
            '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process.\\nDefaults to the user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext. If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
            withRunAsUserName(runAsUserName): { spec+: { template+: { driver+: { podSecurityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } } },
          },
          ...
          withFsGroup(fsGroup): { spec+: { template+: { driver+: { podSecurityContext+: { fsGroup: fsGroup } } } } },
          ...
          withFsGroupChangePolicy(fsGroupChangePolicy): { spec+: { template+: { driver+: { podSecurityContext+: { fsGroupChangePolicy: fsGroupChangePolicy } } } } },
          '#withRunAsGroup':: d.fn(help='"The GID to run the entrypoint of the container process.\\nUses runtime default if unset.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence\\nfor that container.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
          withRunAsGroup(runAsGroup): { spec+: { template+: { driver+: { podSecurityContext+: { runAsGroup: runAsGroup } } } } },
          '#withRunAsNonRoot':: d.fn(help='"Indicates that the container must run as a non-root user.\\nIf true, the Kubelet will validate the image at runtime to ensure that it\\ndoes not run as UID 0 (root) and fail to start the container if it does.\\nIf unset or false, no such validation will be performed.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
          withRunAsNonRoot(runAsNonRoot): { spec+: { template+: { driver+: { podSecurityContext+: { runAsNonRoot: runAsNonRoot } } } } },
          '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process.\\nDefaults to user specified in image metadata if unspecified.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence\\nfor that container.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
          withRunAsUser(runAsUser): { spec+: { template+: { driver+: { podSecurityContext+: { runAsUser: runAsUser } } } } },
          ...
          withSeLinuxChangePolicy(seLinuxChangePolicy): { spec+: { template+: { driver+: { podSecurityContext+: { seLinuxChangePolicy: seLinuxChangePolicy } } } } },
          ...
          withSupplementalGroups(supplementalGroups): { spec+: { template+: { driver+: { podSecurityContext+: { supplementalGroups: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } } },
          ...
          withSupplementalGroupsMixin(supplementalGroups): { spec+: { template+: { driver+: { podSecurityContext+: { supplementalGroups+: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } } },
          ...
          withSupplementalGroupsPolicy(supplementalGroupsPolicy): { spec+: { template+: { driver+: { podSecurityContext+: { supplementalGroupsPolicy: supplementalGroupsPolicy } } } } },
          ...
          withSysctls(sysctls): { spec+: { template+: { driver+: { podSecurityContext+: { sysctls: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } } },
          ...
          withSysctlsMixin(sysctls): { spec+: { template+: { driver+: { podSecurityContext+: { sysctls+: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } } },
        },
        '#ports':: d.obj(help='"Ports settings for the pods, following the Kubernetes specifications."'),
        ports: {
        ...
        '#secrets':: d.obj(help='"Secrets carries information of secrets to add to the pod."'),
        secrets: {
          '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { name: name },
          '#withPath':: d.fn(help='', args=[d.arg(name='path', type=d.T.string)]),
          withPath(path): { path: path },
          '#withSecretType':: d.fn(help='"SecretType tells the type of a secret."', args=[d.arg(name='secretType', type=d.T.string)]),
          withSecretType(secretType): { secretType: secretType },
        },
        '#securityContext':: d.obj(help="\"SecurityContext specifies the container's SecurityContext to apply.\""),
        securityContext: {
          '#appArmorProfile':: d.obj(help="\"appArmorProfile is the AppArmor options to use by this container. If set, this profile\\noverrides the pod's appArmorProfile.\\nNote that this field cannot be set when spec.os.name is windows.\""),
          appArmorProfile: {
            '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used.\\nThe profile must be preconfigured on the node to work.\\nMust match the loaded name of the profile.\\nMust be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { template+: { driver+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied.\\nValid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { driver+: { securityContext+: { appArmorProfile+: { type: type } } } } } },
          },
          '#capabilities':: d.obj(help='"The capabilities to add/drop when running containers.\\nDefaults to the default set of capabilities granted by the container runtime.\\nNote that this field cannot be set when spec.os.name is windows."'),
          capabilities: {
            '#withAdd':: d.fn(help='"Added capabilities"', args=[d.arg(name='add', type=d.T.array)]),
            withAdd(add): { spec+: { template+: { driver+: { securityContext+: { capabilities+: { add: if std.isArray(v=add) then add else [add] } } } } } },
            '#withAddMixin':: d.fn(help='"Added capabilities"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='add', type=d.T.array)]),
            withAddMixin(add): { spec+: { template+: { driver+: { securityContext+: { capabilities+: { add+: if std.isArray(v=add) then add else [add] } } } } } },
            '#withDrop':: d.fn(help='"Removed capabilities"', args=[d.arg(name='drop', type=d.T.array)]),
            withDrop(drop): { spec+: { template+: { driver+: { securityContext+: { capabilities+: { drop: if std.isArray(v=drop) then drop else [drop] } } } } } },
            '#withDropMixin':: d.fn(help='"Removed capabilities"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='drop', type=d.T.array)]),
            withDropMixin(drop): { spec+: { template+: { driver+: { securityContext+: { capabilities+: { drop+: if std.isArray(v=drop) then drop else [drop] } } } } } },
          },
          '#seLinuxOptions':: d.obj(help='"The SELinux context to be applied to the container.\\nIf unspecified, the container runtime will allocate a random SELinux context for each\\ncontainer.  May also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."'),
          seLinuxOptions: {
            '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
            withLevel(level): { spec+: { template+: { driver+: { securityContext+: { seLinuxOptions+: { level: level } } } } } },
            '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
            withRole(role): { spec+: { template+: { driver+: { securityContext+: { seLinuxOptions+: { role: role } } } } } },
            '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { driver+: { securityContext+: { seLinuxOptions+: { type: type } } } } } },
            '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
            withUser(user): { spec+: { template+: { driver+: { securityContext+: { seLinuxOptions+: { user: user } } } } } },
          },
          '#seccompProfile':: d.obj(help='"The seccomp options to use by this container. If seccomp options are\\nprovided at both the pod & container level, the container options\\noverride the pod options.\\nNote that this field cannot be set when spec.os.name is windows."'),
          seccompProfile: {
            '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used.\\nThe profile must be preconfigured on the node to work.\\nMust be a descending path, relative to the kubelet's configured seccomp profile location.\\nMust be set if type is \\\"Localhost\\\". Must NOT be set for any other type.\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { template+: { driver+: { securityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied.\\nValid options are:\\n\\nLocalhost - a profile defined in a file on the node should be used.\\nRuntimeDefault - the container runtime default profile should be used.\\nUnconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { driver+: { securityContext+: { seccompProfile+: { type: type } } } } } },
          },
          '#windowsOptions':: d.obj(help='"The Windows specific settings applied to all containers.\\nIf unspecified, the options from the PodSecurityContext will be used.\\nIf set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is linux."'),
          windowsOptions: {
            '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook\\n(https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the\\nGMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
            withGmsaCredentialSpec(gmsaCredentialSpec): { spec+: { template+: { driver+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } } },
            '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
            withGmsaCredentialSpecName(gmsaCredentialSpecName): { spec+: { template+: { driver+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } } },
            '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container.\\nAll of a Pod's containers must have the same effective HostProcess value\\n(it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).\\nIn addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
            withHostProcess(hostProcess): { spec+: { template+: { driver+: { securityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } } },
            '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process.\\nDefaults to the user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext. If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
            withRunAsUserName(runAsUserName): { spec+: { template+: { driver+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } } },
          },
          '#withAllowPrivilegeEscalation':: d.fn(help='"AllowPrivilegeEscalation controls whether a process can gain more\\nprivileges than its parent process. This bool directly controls if\\nthe no_new_privs flag will be set on the container process.\\nAllowPrivilegeEscalation is true always when the container is:\\n1) run as Privileged\\n2) has CAP_SYS_ADMIN\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='allowPrivilegeEscalation', type=d.T.boolean)]),
          withAllowPrivilegeEscalation(allowPrivilegeEscalation): { spec+: { template+: { driver+: { securityContext+: { allowPrivilegeEscalation: allowPrivilegeEscalation } } } } },
          '#withPrivileged':: d.fn(help='"Run container in privileged mode.\\nProcesses in privileged containers are essentially equivalent to root on the host.\\nDefaults to false.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='privileged', type=d.T.boolean)]),
          withPrivileged(privileged): { spec+: { template+: { driver+: { securityContext+: { privileged: privileged } } } } },
          '#withProcMount':: d.fn(help='"procMount denotes the type of proc mount to use for the containers.\\nThe default value is Default which uses the container runtime defaults for\\nreadonly paths and masked paths.\\nThis requires the ProcMountType feature flag to be enabled.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='procMount', type=d.T.string)]),
          withProcMount(procMount): { spec+: { template+: { driver+: { securityContext+: { procMount: procMount } } } } },
          '#withReadOnlyRootFilesystem':: d.fn(help='"Whether this container has a read-only root filesystem.\\nDefault is false.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='readOnlyRootFilesystem', type=d.T.boolean)]),
          withReadOnlyRootFilesystem(readOnlyRootFilesystem): { spec+: { template+: { driver+: { securityContext+: { readOnlyRootFilesystem: readOnlyRootFilesystem } } } } },
          '#withRunAsGroup':: d.fn(help='"The GID to run the entrypoint of the container process.\\nUses runtime default if unset.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
          withRunAsGroup(runAsGroup): { spec+: { template+: { driver+: { securityContext+: { runAsGroup: runAsGroup } } } } },
          '#withRunAsNonRoot':: d.fn(help='"Indicates that the container must run as a non-root user.\\nIf true, the Kubelet will validate the image at runtime to ensure that it\\ndoes not run as UID 0 (root) and fail to start the container if it does.\\nIf unset or false, no such validation will be performed.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
          withRunAsNonRoot(runAsNonRoot): { spec+: { template+: { driver+: { securityContext+: { runAsNonRoot: runAsNonRoot } } } } },
          '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process.\\nDefaults to user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
          withRunAsUser(runAsUser): { spec+: { template+: { driver+: { securityContext+: { runAsUser: runAsUser } } } } },
        },
        '#sidecars':: d.obj(help='"Sidecars is a list of sidecar containers that run along side the main Spark container."'),
        sidecars: {
          '#env':: d.obj(help='"List of environment variables to set in the container.\\nCannot be updated."'),
          env: {
            '#valueFrom':: d.obj(help="\"Source for the environment variable's value. Cannot be used if value is not empty.\""),
        ...
        '#tolerations':: d.obj(help='"Tolerations specifies the tolerations listed in \\".spec.tolerations\\" to be applied to the pod."'),
        tolerations: {
        ...
        '#volumeMounts':: d.obj(help="\"VolumeMounts specifies the volumes listed in \\\".spec.volumes\\\" to mount into the main container's filesystem.\""),
        volumeMounts: {
          '#withMountPath':: d.fn(help="\"Path within the container at which the volume should be mounted.  Must\\nnot contain ':'.\"", args=[d.arg(name='mountPath', type=d.T.string)]),
          withMountPath(mountPath): { mountPath: mountPath },
          '#withMountPropagation':: d.fn(help='"mountPropagation determines how mounts are propagated from the host\\nto container and the other way around.\\nWhen not set, MountPropagationNone is used.\\nThis field is beta in 1.10.\\nWhen RecursiveReadOnly is set to IfPossible or to Enabled, MountPropagation must be None or unspecified\\n(which defaults to None)."', args=[d.arg(name='mountPropagation', type=d.T.string)]),
        ...
        '#withAnnotations':: d.fn(help='"Annotations are the Kubernetes annotations to be added to the pod."', args=[d.arg(name='annotations', type=d.T.object)]),
        withAnnotations(annotations): { spec+: { template+: { driver+: { annotations: annotations } } } },
        '#withAnnotationsMixin':: d.fn(help='"Annotations are the Kubernetes annotations to be added to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
        withAnnotationsMixin(annotations): { spec+: { template+: { driver+: { annotations+: annotations } } } },
        '#withConfigMaps':: d.fn(help='"ConfigMaps carries information of other ConfigMaps to add to the pod."', args=[d.arg(name='configMaps', type=d.T.array)]),
        withConfigMaps(configMaps): { spec+: { template+: { driver+: { configMaps: if std.isArray(v=configMaps) then configMaps else [configMaps] } } } },
        '#withConfigMapsMixin':: d.fn(help='"ConfigMaps carries information of other ConfigMaps to add to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='configMaps', type=d.T.array)]),
        withConfigMapsMixin(configMaps): { spec+: { template+: { driver+: { configMaps+: if std.isArray(v=configMaps) then configMaps else [configMaps] } } } },
        '#withCoreLimit':: d.fn(help='"CoreLimit specifies a hard limit on CPU cores for the pod.\\nOptional"', args=[d.arg(name='coreLimit', type=d.T.string)]),
        withCoreLimit(coreLimit): { spec+: { template+: { driver+: { coreLimit: coreLimit } } } },
        '#withCoreRequest':: d.fn(help='"CoreRequest is the physical CPU core request for the driver.\\nMaps to `spark.kubernetes.driver.request.cores` that is available since Spark 3.0."', args=[d.arg(name='coreRequest', type=d.T.string)]),
        withCoreRequest(coreRequest): { spec+: { template+: { driver+: { coreRequest: coreRequest } } } },
        '#withCores':: d.fn(help='"Cores maps to `spark.driver.cores` or `spark.executor.cores` for the driver and executors, respectively."', args=[d.arg(name='cores', type=d.T.integer)]),
        withCores(cores): { spec+: { template+: { driver+: { cores: cores } } } },
        '#withEnv':: d.fn(help='"Env carries the environment variables to add to the pod."', args=[d.arg(name='env', type=d.T.array)]),
        withEnv(env): { spec+: { template+: { driver+: { env: if std.isArray(v=env) then env else [env] } } } },
        '#withEnvFrom':: d.fn(help='"EnvFrom is a list of sources to populate environment variables in the container."', args=[d.arg(name='envFrom', type=d.T.array)]),
        withEnvFrom(envFrom): { spec+: { template+: { driver+: { envFrom: if std.isArray(v=envFrom) then envFrom else [envFrom] } } } },
        '#withEnvFromMixin':: d.fn(help='"EnvFrom is a list of sources to populate environment variables in the container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envFrom', type=d.T.array)]),
        withEnvFromMixin(envFrom): { spec+: { template+: { driver+: { envFrom+: if std.isArray(v=envFrom) then envFrom else [envFrom] } } } },
        '#withEnvMixin':: d.fn(help='"Env carries the environment variables to add to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='env', type=d.T.array)]),
        withEnvMixin(env): { spec+: { template+: { driver+: { env+: if std.isArray(v=env) then env else [env] } } } },
        '#withEnvSecretKeyRefs':: d.fn(help='"EnvSecretKeyRefs holds a mapping from environment variable names to SecretKeyRefs.\\nDeprecated. Consider using `env` instead."', args=[d.arg(name='envSecretKeyRefs', type=d.T.object)]),
        withEnvSecretKeyRefs(envSecretKeyRefs): { spec+: { template+: { driver+: { envSecretKeyRefs: envSecretKeyRefs } } } },
        '#withEnvSecretKeyRefsMixin':: d.fn(help='"EnvSecretKeyRefs holds a mapping from environment variable names to SecretKeyRefs.\\nDeprecated. Consider using `env` instead."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envSecretKeyRefs', type=d.T.object)]),
        withEnvSecretKeyRefsMixin(envSecretKeyRefs): { spec+: { template+: { driver+: { envSecretKeyRefs+: envSecretKeyRefs } } } },
        '#withEnvVars':: d.fn(help='"EnvVars carries the environment variables to add to the pod.\\nDeprecated. Consider using `env` instead."', args=[d.arg(name='envVars', type=d.T.object)]),
        withEnvVars(envVars): { spec+: { template+: { driver+: { envVars: envVars } } } },
        '#withEnvVarsMixin':: d.fn(help='"EnvVars carries the environment variables to add to the pod.\\nDeprecated. Consider using `env` instead."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envVars', type=d.T.object)]),
        withEnvVarsMixin(envVars): { spec+: { template+: { driver+: { envVars+: envVars } } } },
        '#withHostAliases':: d.fn(help='"HostAliases settings for the pod, following the Kubernetes specifications."', args=[d.arg(name='hostAliases', type=d.T.array)]),
        withHostAliases(hostAliases): { spec+: { template+: { driver+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } } },
        '#withHostAliasesMixin':: d.fn(help='"HostAliases settings for the pod, following the Kubernetes specifications."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hostAliases', type=d.T.array)]),
        withHostAliasesMixin(hostAliases): { spec+: { template+: { driver+: { hostAliases+: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } } },
        '#withHostNetwork':: d.fn(help='"HostNetwork indicates whether to request host networking for the pod or not."', args=[d.arg(name='hostNetwork', type=d.T.boolean)]),
        withHostNetwork(hostNetwork): { spec+: { template+: { driver+: { hostNetwork: hostNetwork } } } },
        '#withImage':: d.fn(help='"Image is the container image to use. Overrides Spec.Image if set."', args=[d.arg(name='image', type=d.T.string)]),
        withImage(image): { spec+: { template+: { driver+: { image: image } } } },
        '#withInitContainers':: d.fn(help='"InitContainers is a list of init-containers that run to completion before the main Spark container."', args=[d.arg(name='initContainers', type=d.T.array)]),
        withInitContainers(initContainers): { spec+: { template+: { driver+: { initContainers: if std.isArray(v=initContainers) then initContainers else [initContainers] } } } },
        '#withInitContainersMixin':: d.fn(help='"InitContainers is a list of init-containers that run to completion before the main Spark container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='initContainers', type=d.T.array)]),
        withInitContainersMixin(initContainers): { spec+: { template+: { driver+: { initContainers+: if std.isArray(v=initContainers) then initContainers else [initContainers] } } } },
        '#withJavaOptions':: d.fn(help='"JavaOptions is a string of extra JVM options to pass to the driver. For instance,\\nGC settings or other logging."', args=[d.arg(name='javaOptions', type=d.T.string)]),
        withJavaOptions(javaOptions): { spec+: { template+: { driver+: { javaOptions: javaOptions } } } },
        '#withKubernetesMaster':: d.fn(help='"KubernetesMaster is the URL of the Kubernetes master used by the driver to manage executor pods and\\nother Kubernetes resources. Default to https://kubernetes.default.svc."', args=[d.arg(name='kubernetesMaster', type=d.T.string)]),
        withKubernetesMaster(kubernetesMaster): { spec+: { template+: { driver+: { kubernetesMaster: kubernetesMaster } } } },
        '#withLabels':: d.fn(help='"Labels are the Kubernetes labels to be added to the pod."', args=[d.arg(name='labels', type=d.T.object)]),
        withLabels(labels): { spec+: { template+: { driver+: { labels: labels } } } },
        '#withLabelsMixin':: d.fn(help='"Labels are the Kubernetes labels to be added to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
        withLabelsMixin(labels): { spec+: { template+: { driver+: { labels+: labels } } } },
        '#withMemory':: d.fn(help='"Memory is the amount of memory to request for the pod."', args=[d.arg(name='memory', type=d.T.string)]),
        withMemory(memory): { spec+: { template+: { driver+: { memory: memory } } } },
        '#withMemoryLimit':: d.fn(help='"MemoryLimit overrides the memory limit of the pod."', args=[d.arg(name='memoryLimit', type=d.T.string)]),
        withMemoryLimit(memoryLimit): { spec+: { template+: { driver+: { memoryLimit: memoryLimit } } } },
        '#withMemoryOverhead':: d.fn(help='"MemoryOverhead is the amount of off-heap memory to allocate in cluster mode, in MiB unless otherwise specified."', args=[d.arg(name='memoryOverhead', type=d.T.string)]),
        withMemoryOverhead(memoryOverhead): { spec+: { template+: { driver+: { memoryOverhead: memoryOverhead } } } },
        '#withNodeSelector':: d.fn(help='"NodeSelector is the Kubernetes node selector to be added to the driver and executor pods.\\nThis field is mutually exclusive with nodeSelector at SparkApplication level (which will be deprecated)."', args=[d.arg(name='nodeSelector', type=d.T.object)]),
        withNodeSelector(nodeSelector): { spec+: { template+: { driver+: { nodeSelector: nodeSelector } } } },
        '#withNodeSelectorMixin':: d.fn(help='"NodeSelector is the Kubernetes node selector to be added to the driver and executor pods.\\nThis field is mutually exclusive with nodeSelector at SparkApplication level (which will be deprecated)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeSelector', type=d.T.object)]),
        withNodeSelectorMixin(nodeSelector): { spec+: { template+: { driver+: { nodeSelector+: nodeSelector } } } },
        '#withPodName':: d.fn(help="\"PodName is the name of the driver pod that the user creates. This is used for the\\nin-cluster client mode in which the user creates a client pod where the driver of\\nthe user application runs. It's an error to set this field if Mode is not\\nin-cluster-client.\"", args=[d.arg(name='podName', type=d.T.string)]),
        withPodName(podName): { spec+: { template+: { driver+: { podName: podName } } } },
        '#withPorts':: d.fn(help='"Ports settings for the pods, following the Kubernetes specifications."', args=[d.arg(name='ports', type=d.T.array)]),
        withPorts(ports): { spec+: { template+: { driver+: { ports: if std.isArray(v=ports) then ports else [ports] } } } },
        '#withPortsMixin':: d.fn(help='"Ports settings for the pods, following the Kubernetes specifications."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ports', type=d.T.array)]),
        withPortsMixin(ports): { spec+: { template+: { driver+: { ports+: if std.isArray(v=ports) then ports else [ports] } } } },
        '#withPriorityClassName':: d.fn(help='"PriorityClassName is the name of the PriorityClass for the driver pod."', args=[d.arg(name='priorityClassName', type=d.T.string)]),
        withPriorityClassName(priorityClassName): { spec+: { template+: { driver+: { priorityClassName: priorityClassName } } } },
        '#withSchedulerName':: d.fn(help='"SchedulerName specifies the scheduler that will be used for scheduling"', args=[d.arg(name='schedulerName', type=d.T.string)]),
        withSchedulerName(schedulerName): { spec+: { template+: { driver+: { schedulerName: schedulerName } } } },
        '#withSecrets':: d.fn(help='"Secrets carries information of secrets to add to the pod."', args=[d.arg(name='secrets', type=d.T.array)]),
        withSecrets(secrets): { spec+: { template+: { driver+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } } } },
        '#withSecretsMixin':: d.fn(help='"Secrets carries information of secrets to add to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.array)]),
        withSecretsMixin(secrets): { spec+: { template+: { driver+: { secrets+: if std.isArray(v=secrets) then secrets else [secrets] } } } },
        '#withServiceAccount':: d.fn(help='"ServiceAccount is the name of the custom Kubernetes service account used by the pod."', args=[d.arg(name='serviceAccount', type=d.T.string)]),
        withServiceAccount(serviceAccount): { spec+: { template+: { driver+: { serviceAccount: serviceAccount } } } },
        '#withServiceAnnotations':: d.fn(help='"ServiceAnnotations defines the annotations to be added to the Kubernetes headless service used by\\nexecutors to connect to the driver."', args=[d.arg(name='serviceAnnotations', type=d.T.object)]),
        withServiceAnnotations(serviceAnnotations): { spec+: { template+: { driver+: { serviceAnnotations: serviceAnnotations } } } },
        '#withServiceAnnotationsMixin':: d.fn(help='"ServiceAnnotations defines the annotations to be added to the Kubernetes headless service used by\\nexecutors to connect to the driver."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceAnnotations', type=d.T.object)]),
        withServiceAnnotationsMixin(serviceAnnotations): { spec+: { template+: { driver+: { serviceAnnotations+: serviceAnnotations } } } },
        '#withServiceLabels':: d.fn(help='"ServiceLabels defines the labels to be added to the Kubernetes headless service used by\\nexecutors to connect to the driver."', args=[d.arg(name='serviceLabels', type=d.T.object)]),
        withServiceLabels(serviceLabels): { spec+: { template+: { driver+: { serviceLabels: serviceLabels } } } },
        '#withServiceLabelsMixin':: d.fn(help='"ServiceLabels defines the labels to be added to the Kubernetes headless service used by\\nexecutors to connect to the driver."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceLabels', type=d.T.object)]),
        withServiceLabelsMixin(serviceLabels): { spec+: { template+: { driver+: { serviceLabels+: serviceLabels } } } },
        '#withShareProcessNamespace':: d.fn(help='"ShareProcessNamespace settings for the pod, following the Kubernetes specifications."', args=[d.arg(name='shareProcessNamespace', type=d.T.boolean)]),
        withShareProcessNamespace(shareProcessNamespace): { spec+: { template+: { driver+: { shareProcessNamespace: shareProcessNamespace } } } },
        '#withSidecars':: d.fn(help='"Sidecars is a list of sidecar containers that run along side the main Spark container."', args=[d.arg(name='sidecars', type=d.T.array)]),
        withSidecars(sidecars): { spec+: { template+: { driver+: { sidecars: if std.isArray(v=sidecars) then sidecars else [sidecars] } } } },
        '#withSidecarsMixin':: d.fn(help='"Sidecars is a list of sidecar containers that run along side the main Spark container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sidecars', type=d.T.array)]),
        withSidecarsMixin(sidecars): { spec+: { template+: { driver+: { sidecars+: if std.isArray(v=sidecars) then sidecars else [sidecars] } } } },
        '#withTemplate':: d.fn(help='"Template is a pod template that can be used to define the driver or executor pod configurations that Spark configurations do not support.\\nSpark version >= 3.0.0 is required.\\nRef: https://spark.apache.org/docs/latest/running-on-kubernetes.html#pod-template."', args=[d.arg(name='template', type=d.T.object)]),
        withTemplate(template): { spec+: { template+: { driver+: { template: template } } } },
        '#withTemplateMixin':: d.fn(help='"Template is a pod template that can be used to define the driver or executor pod configurations that Spark configurations do not support.\\nSpark version >= 3.0.0 is required.\\nRef: https://spark.apache.org/docs/latest/running-on-kubernetes.html#pod-template."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='template', type=d.T.object)]),
        withTemplateMixin(template): { spec+: { template+: { driver+: { template+: template } } } },
        '#withTerminationGracePeriodSeconds':: d.fn(help='"Termination grace period seconds for the pod"', args=[d.arg(name='terminationGracePeriodSeconds', type=d.T.integer)]),
        withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { spec+: { template+: { driver+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } } },
        '#withTolerations':: d.fn(help='"Tolerations specifies the tolerations listed in \\".spec.tolerations\\" to be applied to the pod."', args=[d.arg(name='tolerations', type=d.T.array)]),
        withTolerations(tolerations): { spec+: { template+: { driver+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } } } },
        '#withTolerationsMixin':: d.fn(help='"Tolerations specifies the tolerations listed in \\".spec.tolerations\\" to be applied to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tolerations', type=d.T.array)]),
        withTolerationsMixin(tolerations): { spec+: { template+: { driver+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } } } },
        '#withVolumeMounts':: d.fn(help="\"VolumeMounts specifies the volumes listed in \\\".spec.volumes\\\" to mount into the main container's filesystem.\"", args=[d.arg(name='volumeMounts', type=d.T.array)]),
        withVolumeMounts(volumeMounts): { spec+: { template+: { driver+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
        '#withVolumeMountsMixin':: d.fn(help="\"VolumeMounts specifies the volumes listed in \\\".spec.volumes\\\" to mount into the main container's filesystem.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='volumeMounts', type=d.T.array)]),
        withVolumeMountsMixin(volumeMounts): { spec+: { template+: { driver+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
      },
      '#driverIngressOptions':: d.obj(help='"DriverIngressOptions allows configuring the Service and the Ingress to expose ports inside Spark Driver"'),
      driverIngressOptions: {
        '#ingressTLS':: d.obj(help='"TlsHosts is useful If we need to declare SSL certificates to the ingress object"'),
        ingressTLS: {
        ...
        '#withIngressAnnotations':: d.fn(help='"IngressAnnotations is a map of key,value pairs of annotations that might be added to the ingress object. i.e. specify nginx as ingress.class"', args=[d.arg(name='ingressAnnotations', type=d.T.object)]),
        withIngressAnnotations(ingressAnnotations): { ingressAnnotations: ingressAnnotations },
        '#withIngressAnnotationsMixin':: d.fn(help='"IngressAnnotations is a map of key,value pairs of annotations that might be added to the ingress object. i.e. specify nginx as ingress.class"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ingressAnnotations', type=d.T.object)]),
        withIngressAnnotationsMixin(ingressAnnotations): { ingressAnnotations+: ingressAnnotations },
        '#withIngressTLS':: d.fn(help='"TlsHosts is useful If we need to declare SSL certificates to the ingress object"', args=[d.arg(name='ingressTLS', type=d.T.array)]),
        withIngressTLS(ingressTLS): { ingressTLS: if std.isArray(v=ingressTLS) then ingressTLS else [ingressTLS] },
        '#withIngressTLSMixin':: d.fn(help='"TlsHosts is useful If we need to declare SSL certificates to the ingress object"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ingressTLS', type=d.T.array)]),
        withIngressTLSMixin(ingressTLS): { ingressTLS+: if std.isArray(v=ingressTLS) then ingressTLS else [ingressTLS] },
        '#withIngressURLFormat':: d.fn(help='"IngressURLFormat is the URL for the ingress."', args=[d.arg(name='ingressURLFormat', type=d.T.string)]),
        withIngressURLFormat(ingressURLFormat): { ingressURLFormat: ingressURLFormat },
        '#withServiceAnnotations':: d.fn(help='"ServiceAnnotations is a map of key,value pairs of annotations that might be added to the service object."', args=[d.arg(name='serviceAnnotations', type=d.T.object)]),
        withServiceAnnotations(serviceAnnotations): { serviceAnnotations: serviceAnnotations },
        '#withServiceAnnotationsMixin':: d.fn(help='"ServiceAnnotations is a map of key,value pairs of annotations that might be added to the service object."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceAnnotations', type=d.T.object)]),
        withServiceAnnotationsMixin(serviceAnnotations): { serviceAnnotations+: serviceAnnotations },
        '#withServiceLabels':: d.fn(help='"ServiceLabels is a map of key,value pairs of labels that might be added to the service object."', args=[d.arg(name='serviceLabels', type=d.T.object)]),
        withServiceLabels(serviceLabels): { serviceLabels: serviceLabels },
        '#withServiceLabelsMixin':: d.fn(help='"ServiceLabels is a map of key,value pairs of labels that might be added to the service object."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceLabels', type=d.T.object)]),
        withServiceLabelsMixin(serviceLabels): { serviceLabels+: serviceLabels },
        '#withServicePort':: d.fn(help='"ServicePort allows configuring the port at service level that might be different from the targetPort."', args=[d.arg(name='servicePort', type=d.T.integer)]),
        withServicePort(servicePort): { servicePort: servicePort },
        '#withServicePortName':: d.fn(help='"ServicePortName allows configuring the name of the service port.\\nThis may be useful for sidecar proxies like Envoy injected by Istio which require specific ports names to treat traffic as proper HTTP."', args=[d.arg(name='servicePortName', type=d.T.string)]),
        withServicePortName(servicePortName): { servicePortName: servicePortName },
        '#withServiceType':: d.fn(help='"ServiceType allows configuring the type of the service. Defaults to ClusterIP."', args=[d.arg(name='serviceType', type=d.T.string)]),
        withServiceType(serviceType): { serviceType: serviceType },
      },
      '#dynamicAllocation':: d.obj(help='"DynamicAllocation configures dynamic allocation that becomes available for the Kubernetes\\nscheduler backend since Spark 3.0."'),
      dynamicAllocation: {
        '#withEnabled':: d.fn(help='"Enabled controls whether dynamic allocation is enabled or not."', args=[d.arg(name='enabled', type=d.T.boolean)]),
        withEnabled(enabled): { spec+: { template+: { dynamicAllocation+: { enabled: enabled } } } },
        '#withInitialExecutors':: d.fn(help='"InitialExecutors is the initial number of executors to request. If .spec.executor.instances\\nis also set, the initial number of executors is set to the bigger of that and this option."', args=[d.arg(name='initialExecutors', type=d.T.integer)]),
        withInitialExecutors(initialExecutors): { spec+: { template+: { dynamicAllocation+: { initialExecutors: initialExecutors } } } },
        '#withMaxExecutors':: d.fn(help='"MaxExecutors is the upper bound for the number of executors if dynamic allocation is enabled."', args=[d.arg(name='maxExecutors', type=d.T.integer)]),
        withMaxExecutors(maxExecutors): { spec+: { template+: { dynamicAllocation+: { maxExecutors: maxExecutors } } } },
        '#withMinExecutors':: d.fn(help='"MinExecutors is the lower bound for the number of executors if dynamic allocation is enabled."', args=[d.arg(name='minExecutors', type=d.T.integer)]),
        withMinExecutors(minExecutors): { spec+: { template+: { dynamicAllocation+: { minExecutors: minExecutors } } } },
        '#withShuffleTrackingEnabled':: d.fn(help='"ShuffleTrackingEnabled enables shuffle file tracking for executors, which allows dynamic allocation without\\nthe need for an external shuffle service. This option will try to keep alive executors that are storing\\nshuffle data for active jobs. If external shuffle service is enabled, set ShuffleTrackingEnabled to false.\\nShuffleTrackingEnabled is true by default if dynamicAllocation.enabled is true."', args=[d.arg(name='shuffleTrackingEnabled', type=d.T.boolean)]),
        withShuffleTrackingEnabled(shuffleTrackingEnabled): { spec+: { template+: { dynamicAllocation+: { shuffleTrackingEnabled: shuffleTrackingEnabled } } } },
        '#withShuffleTrackingTimeout':: d.fn(help='"ShuffleTrackingTimeout controls the timeout in milliseconds for executors that are holding\\nshuffle data if shuffle tracking is enabled (true by default if dynamic allocation is enabled)."', args=[d.arg(name='shuffleTrackingTimeout', type=d.T.integer)]),
        withShuffleTrackingTimeout(shuffleTrackingTimeout): { spec+: { template+: { dynamicAllocation+: { shuffleTrackingTimeout: shuffleTrackingTimeout } } } },
      },
      '#executor':: d.obj(help='"Executor is the executor specification."'),
      executor: {
        '#affinity':: d.obj(help='"Affinity specifies the affinity/anti-affinity settings for the pod."'),
        affinity: {
          '#nodeAffinity':: d.obj(help='"Describes node affinity scheduling rules for the pod."'),
          nodeAffinity: {
            ...
            requiredDuringSchedulingIgnoredDuringExecution: {
              ...
              '#withNodeSelectorTerms':: d.fn(help='"Required. A list of node selector terms. The terms are ORed."', args=[d.arg(name='nodeSelectorTerms', type=d.T.array)]),
              withNodeSelectorTerms(nodeSelectorTerms): { spec+: { template+: { executor+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } } },
              '#withNodeSelectorTermsMixin':: d.fn(help='"Required. A list of node selector terms. The terms are ORed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeSelectorTerms', type=d.T.array)]),
              withNodeSelectorTermsMixin(nodeSelectorTerms): { spec+: { template+: { executor+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms+: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } } },
            },
            '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node matches the corresponding matchExpressions; the\\nnode(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { executor+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node matches the corresponding matchExpressions; the\\nnode(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { executor+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
          '#podAffinity':: d.obj(help='"Describes pod affinity scheduling rules (e.g. co-locate this pod in the same node, zone, etc. as some other pod(s))."'),
          podAffinity: {
            '#preferredDuringSchedulingIgnoredDuringExecution':: d.obj(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."'),
            ...
            '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { executor+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { executor+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withRequiredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"If the affinity requirements specified by this field are not met at\\nscheduling time, the pod will not be scheduled onto the node.\\nIf the affinity requirements specified by this field cease to be met\\nat some point during pod execution (e.g. due to a pod label update), the\\nsystem may or may not try to eventually evict the pod from its node.\\nWhen there are multiple elements, the lists of nodes corresponding to each\\npodAffinityTerm are intersected, i.e. all terms must be satisfied."', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { executor+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withRequiredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"If the affinity requirements specified by this field are not met at\\nscheduling time, the pod will not be scheduled onto the node.\\nIf the affinity requirements specified by this field cease to be met\\nat some point during pod execution (e.g. due to a pod label update), the\\nsystem may or may not try to eventually evict the pod from its node.\\nWhen there are multiple elements, the lists of nodes corresponding to each\\npodAffinityTerm are intersected, i.e. all terms must be satisfied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { executor+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
          '#podAntiAffinity':: d.obj(help='"Describes pod anti-affinity scheduling rules (e.g. avoid putting this pod in the same node, zone, etc. as some other pod(s))."'),
          podAntiAffinity: {
            '#preferredDuringSchedulingIgnoredDuringExecution':: d.obj(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe anti-affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling anti-affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."'),
            ...
            '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe anti-affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling anti-affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { executor+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe anti-affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling anti-affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { executor+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withRequiredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"If the anti-affinity requirements specified by this field are not met at\\nscheduling time, the pod will not be scheduled onto the node.\\nIf the anti-affinity requirements specified by this field cease to be met\\nat some point during pod execution (e.g. due to a pod label update), the\\nsystem may or may not try to eventually evict the pod from its node.\\nWhen there are multiple elements, the lists of nodes corresponding to each\\npodAffinityTerm are intersected, i.e. all terms must be satisfied."', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { executor+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withRequiredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"If the anti-affinity requirements specified by this field are not met at\\nscheduling time, the pod will not be scheduled onto the node.\\nIf the anti-affinity requirements specified by this field cease to be met\\nat some point during pod execution (e.g. due to a pod label update), the\\nsystem may or may not try to eventually evict the pod from its node.\\nWhen there are multiple elements, the lists of nodes corresponding to each\\npodAffinityTerm are intersected, i.e. all terms must be satisfied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { template+: { executor+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
        },
        '#configMaps':: d.obj(help='"ConfigMaps carries information of other ConfigMaps to add to the pod."'),
        configMaps: {
        ...
        dnsConfig: {
          ...
          '#withNameservers':: d.fn(help='"A list of DNS name server IP addresses.\\nThis will be appended to the base nameservers generated from DNSPolicy.\\nDuplicated nameservers will be removed."', args=[d.arg(name='nameservers', type=d.T.array)]),
          withNameservers(nameservers): { spec+: { template+: { executor+: { dnsConfig+: { nameservers: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } } },
          '#withNameserversMixin':: d.fn(help='"A list of DNS name server IP addresses.\\nThis will be appended to the base nameservers generated from DNSPolicy.\\nDuplicated nameservers will be removed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nameservers', type=d.T.array)]),
          withNameserversMixin(nameservers): { spec+: { template+: { executor+: { dnsConfig+: { nameservers+: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } } },
          '#withOptions':: d.fn(help='"A list of DNS resolver options.\\nThis will be merged with the base options generated from DNSPolicy.\\nDuplicated entries will be removed. Resolution options given in Options\\nwill override those that appear in the base DNSPolicy."', args=[d.arg(name='options', type=d.T.array)]),
          withOptions(options): { spec+: { template+: { executor+: { dnsConfig+: { options: if std.isArray(v=options) then options else [options] } } } } },
          '#withOptionsMixin':: d.fn(help='"A list of DNS resolver options.\\nThis will be merged with the base options generated from DNSPolicy.\\nDuplicated entries will be removed. Resolution options given in Options\\nwill override those that appear in the base DNSPolicy."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='options', type=d.T.array)]),
          withOptionsMixin(options): { spec+: { template+: { executor+: { dnsConfig+: { options+: if std.isArray(v=options) then options else [options] } } } } },
          '#withSearches':: d.fn(help='"A list of DNS search domains for host-name lookup.\\nThis will be appended to the base search paths generated from DNSPolicy.\\nDuplicated search paths will be removed."', args=[d.arg(name='searches', type=d.T.array)]),
          withSearches(searches): { spec+: { template+: { executor+: { dnsConfig+: { searches: if std.isArray(v=searches) then searches else [searches] } } } } },
          '#withSearchesMixin':: d.fn(help='"A list of DNS search domains for host-name lookup.\\nThis will be appended to the base search paths generated from DNSPolicy.\\nDuplicated search paths will be removed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='searches', type=d.T.array)]),
          withSearchesMixin(searches): { spec+: { template+: { executor+: { dnsConfig+: { searches+: if std.isArray(v=searches) then searches else [searches] } } } } },
        },
        '#env':: d.obj(help='"Env carries the environment variables to add to the pod."'),
        env: {
          '#valueFrom':: d.obj(help="\"Source for the environment variable's value. Cannot be used if value is not empty.\""),
        ...
        gpu: {
          '#withName':: d.fn(help='"Name is GPU resource name, such as: nvidia.com/gpu or amd.com/gpu"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { template+: { executor+: { gpu+: { name: name } } } } },
          '#withQuantity':: d.fn(help='"Quantity is the number of GPUs to request for driver or executor."', args=[d.arg(name='quantity', type=d.T.integer)]),
          withQuantity(quantity): { spec+: { template+: { executor+: { gpu+: { quantity: quantity } } } } },
        },
        '#hostAliases':: d.obj(help='"HostAliases settings for the pod, following the Kubernetes specifications."'),
        hostAliases: {
          '#withHostnames':: d.fn(help='"Hostnames for the above IP address."', args=[d.arg(name='hostnames', type=d.T.array)]),
        ...
        lifecycle: {
          ...
          postStart: {
            ...
            exec: {
              '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
              withCommand(command): { spec+: { template+: { executor+: { lifecycle+: { postStart+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } } },
              '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
              withCommandMixin(command): { spec+: { template+: { executor+: { lifecycle+: { postStart+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } } },
            },
            '#httpGet':: d.obj(help='"HTTPGet specifies an HTTP GET request to perform."'),
            httpGet: {
              '#httpHeaders':: d.obj(help='"Custom headers to set in the request. HTTP allows repeated headers."'),
              ...
              '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set\\n\\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
              withHost(host): { spec+: { template+: { executor+: { lifecycle+: { postStart+: { httpGet+: { host: host } } } } } } },
              '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
              withHttpHeaders(httpHeaders): { spec+: { template+: { executor+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } } },
              '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
              withHttpHeadersMixin(httpHeaders): { spec+: { template+: { executor+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } } },
              '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
              withPath(path): { spec+: { template+: { executor+: { lifecycle+: { postStart+: { httpGet+: { path: path } } } } } } },
              '#withPort':: d.fn(help='"Name or number of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
              withPort(port): { spec+: { template+: { executor+: { lifecycle+: { postStart+: { httpGet+: { port: port } } } } } } },
              '#withScheme':: d.fn(help='"Scheme to use for connecting to the host.\\nDefaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
              withScheme(scheme): { spec+: { template+: { executor+: { lifecycle+: { postStart+: { httpGet+: { scheme: scheme } } } } } } },
            },
            '#sleep':: d.obj(help='"Sleep represents a duration that the container should sleep."'),
            sleep: {
              '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
              withSeconds(seconds): { spec+: { template+: { executor+: { lifecycle+: { postStart+: { sleep+: { seconds: seconds } } } } } } },
            },
            '#tcpSocket':: d.obj(help='"Deprecated. TCPSocket is NOT supported as a LifecycleHandler and kept\\nfor backward compatibility. There is no validation of this field and\\nlifecycle hooks will fail at runtime when it is specified."'),
            tcpSocket: {
              '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
              withHost(host): { spec+: { template+: { executor+: { lifecycle+: { postStart+: { tcpSocket+: { host: host } } } } } } },
              '#withPort':: d.fn(help='"Number or name of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
              withPort(port): { spec+: { template+: { executor+: { lifecycle+: { postStart+: { tcpSocket+: { port: port } } } } } } },
            },
          },
          '#preStop':: d.obj(help="\"PreStop is called immediately before a container is terminated due to an\\nAPI request or management event such as liveness/startup probe failure,\\npreemption, resource contention, etc. The handler is not called if the\\ncontainer crashes or exits. The Pod's termination grace period countdown begins before the\\nPreStop hook is executed. Regardless of the outcome of the handler, the\\ncontainer will eventually terminate within the Pod's termination grace\\nperiod (unless delayed by finalizers). Other management of the container blocks until the hook completes\\nor until the termination grace period is reached.\\nMore info: https://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/#container-hooks\""),
          preStop: {
            ...
            exec: {
              '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
              withCommand(command): { spec+: { template+: { executor+: { lifecycle+: { preStop+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } } },
              '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
              withCommandMixin(command): { spec+: { template+: { executor+: { lifecycle+: { preStop+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } } },
            },
            '#httpGet':: d.obj(help='"HTTPGet specifies an HTTP GET request to perform."'),
            httpGet: {
              '#httpHeaders':: d.obj(help='"Custom headers to set in the request. HTTP allows repeated headers."'),
              ...
              '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set\\n\\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
              withHost(host): { spec+: { template+: { executor+: { lifecycle+: { preStop+: { httpGet+: { host: host } } } } } } },
              '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
              withHttpHeaders(httpHeaders): { spec+: { template+: { executor+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } } },
              '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
              withHttpHeadersMixin(httpHeaders): { spec+: { template+: { executor+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } } },
              '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
              withPath(path): { spec+: { template+: { executor+: { lifecycle+: { preStop+: { httpGet+: { path: path } } } } } } },
              '#withPort':: d.fn(help='"Name or number of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
              withPort(port): { spec+: { template+: { executor+: { lifecycle+: { preStop+: { httpGet+: { port: port } } } } } } },
              '#withScheme':: d.fn(help='"Scheme to use for connecting to the host.\\nDefaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
              withScheme(scheme): { spec+: { template+: { executor+: { lifecycle+: { preStop+: { httpGet+: { scheme: scheme } } } } } } },
            },
            '#sleep':: d.obj(help='"Sleep represents a duration that the container should sleep."'),
            sleep: {
              '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
              withSeconds(seconds): { spec+: { template+: { executor+: { lifecycle+: { preStop+: { sleep+: { seconds: seconds } } } } } } },
            },
            '#tcpSocket':: d.obj(help='"Deprecated. TCPSocket is NOT supported as a LifecycleHandler and kept\\nfor backward compatibility. There is no validation of this field and\\nlifecycle hooks will fail at runtime when it is specified."'),
            tcpSocket: {
              '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
              withHost(host): { spec+: { template+: { executor+: { lifecycle+: { preStop+: { tcpSocket+: { host: host } } } } } } },
              '#withPort':: d.fn(help='"Number or name of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
              withPort(port): { spec+: { template+: { executor+: { lifecycle+: { preStop+: { tcpSocket+: { port: port } } } } } } },
            },
          },
        },
        '#podSecurityContext':: d.obj(help='"PodSecurityContext specifies the PodSecurityContext to apply."'),
        podSecurityContext: {
          ...
          appArmorProfile: {
            '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used.\\nThe profile must be preconfigured on the node to work.\\nMust match the loaded name of the profile.\\nMust be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { template+: { executor+: { podSecurityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied.\\nValid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { executor+: { podSecurityContext+: { appArmorProfile+: { type: type } } } } } },
          },
          '#seLinuxOptions':: d.obj(help='"The SELinux context to be applied to all containers.\\nIf unspecified, the container runtime will allocate a random SELinux context for each\\ncontainer.  May also be set in SecurityContext.  If set in\\nboth SecurityContext and PodSecurityContext, the value specified in SecurityContext\\ntakes precedence for that container.\\nNote that this field cannot be set when spec.os.name is windows."'),
          seLinuxOptions: {
            '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
            withLevel(level): { spec+: { template+: { executor+: { podSecurityContext+: { seLinuxOptions+: { level: level } } } } } },
            '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
            withRole(role): { spec+: { template+: { executor+: { podSecurityContext+: { seLinuxOptions+: { role: role } } } } } },
            '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { executor+: { podSecurityContext+: { seLinuxOptions+: { type: type } } } } } },
            '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
            withUser(user): { spec+: { template+: { executor+: { podSecurityContext+: { seLinuxOptions+: { user: user } } } } } },
          },
          '#seccompProfile':: d.obj(help='"The seccomp options to use by the containers in this pod.\\nNote that this field cannot be set when spec.os.name is windows."'),
          seccompProfile: {
            '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used.\\nThe profile must be preconfigured on the node to work.\\nMust be a descending path, relative to the kubelet's configured seccomp profile location.\\nMust be set if type is \\\"Localhost\\\". Must NOT be set for any other type.\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { template+: { executor+: { podSecurityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied.\\nValid options are:\\n\\nLocalhost - a profile defined in a file on the node should be used.\\nRuntimeDefault - the container runtime default profile should be used.\\nUnconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { executor+: { podSecurityContext+: { seccompProfile+: { type: type } } } } } },
          },
          '#sysctls':: d.obj(help='"Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported\\nsysctls (by the container runtime) might fail to launch.\\nNote that this field cannot be set when spec.os.name is windows."'),
          sysctls: {
            '#withName':: d.fn(help='"Name of a property to set"', args=[d.arg(name='name', type=d.T.string)]),
          ...
          windowsOptions: {
            '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook\\n(https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the\\nGMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
            withGmsaCredentialSpec(gmsaCredentialSpec): { spec+: { template+: { executor+: { podSecurityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } } },
            '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
            withGmsaCredentialSpecName(gmsaCredentialSpecName): { spec+: { template+: { executor+: { podSecurityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } } },
            '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container.\\nAll of a Pod's containers must have the same effective HostProcess value\\n(it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).\\nIn addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
            withHostProcess(hostProcess): { spec+: { template+: { executor+: { podSecurityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } } },
            '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process.\\nDefaults to the user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext. If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
            withRunAsUserName(runAsUserName): { spec+: { template+: { executor+: { podSecurityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } } },
          },
          '#withFsGroup':: d.fn(help="\"A special supplemental group that applies to all containers in a pod.\\nSome volume types allow the Kubelet to change the ownership of that volume\\nto be owned by the pod:\\n\\n1. The owning GID will be the FSGroup\\n2. The setgid bit is set (new files created in the volume will be owned by FSGroup)\\n3. The permission bits are OR'd with rw-rw----\\n\\nIf unset, the Kubelet will not modify the ownership and permissions of any volume.\\nNote that this field cannot be set when spec.os.name is windows.\"", args=[d.arg(name='fsGroup', type=d.T.integer)]),
          withFsGroup(fsGroup): { spec+: { template+: { executor+: { podSecurityContext+: { fsGroup: fsGroup } } } } },
          '#withFsGroupChangePolicy':: d.fn(help='"fsGroupChangePolicy defines behavior of changing ownership and permission of the volume\\nbefore being exposed inside Pod. This field will only apply to\\nvolume types which support fsGroup based ownership(and permissions).\\nIt will have no effect on ephemeral volume types such as: secret, configmaps\\nand emptydir.\\nValid values are \\"OnRootMismatch\\" and \\"Always\\". If not specified, \\"Always\\" is used.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='fsGroupChangePolicy', type=d.T.string)]),
          withFsGroupChangePolicy(fsGroupChangePolicy): { spec+: { template+: { executor+: { podSecurityContext+: { fsGroupChangePolicy: fsGroupChangePolicy } } } } },
          '#withRunAsGroup':: d.fn(help='"The GID to run the entrypoint of the container process.\\nUses runtime default if unset.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence\\nfor that container.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
          withRunAsGroup(runAsGroup): { spec+: { template+: { executor+: { podSecurityContext+: { runAsGroup: runAsGroup } } } } },
          '#withRunAsNonRoot':: d.fn(help='"Indicates that the container must run as a non-root user.\\nIf true, the Kubelet will validate the image at runtime to ensure that it\\ndoes not run as UID 0 (root) and fail to start the container if it does.\\nIf unset or false, no such validation will be performed.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
          withRunAsNonRoot(runAsNonRoot): { spec+: { template+: { executor+: { podSecurityContext+: { runAsNonRoot: runAsNonRoot } } } } },
          '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process.\\nDefaults to user specified in image metadata if unspecified.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence\\nfor that container.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
          withRunAsUser(runAsUser): { spec+: { template+: { executor+: { podSecurityContext+: { runAsUser: runAsUser } } } } },
          '#withSeLinuxChangePolicy':: d.fn(help="\"seLinuxChangePolicy defines how the container's SELinux label is applied to all volumes used by the Pod.\\nIt has no effect on nodes that do not support SELinux or to volumes does not support SELinux.\\nValid values are \\\"MountOption\\\" and \\\"Recursive\\\".\\n\\n\\\"Recursive\\\" means relabeling of all files on all Pod volumes by the container runtime.\\nThis may be slow for large volumes, but allows mixing privileged and unprivileged Pods sharing the same volume on the same node.\\n\\n\\\"MountOption\\\" mounts all eligible Pod volumes with `-o context` mount option.\\nThis requires all Pods that share the same volume to use the same SELinux label.\\nIt is not possible to share the same volume among privileged and unprivileged Pods.\\nEligible volumes are in-tree FibreChannel and iSCSI volumes, and all CSI volumes\\nwhose CSI driver announces SELinux support by setting spec.seLinuxMount: true in their\\nCSIDriver instance. Other volumes are always re-labelled recursively.\\n\\\"MountOption\\\" value is allowed only when SELinuxMount feature gate is enabled.\\n\\nIf not specified and SELinuxMount feature gate is enabled, \\\"MountOption\\\" is used.\\nIf not specified and SELinuxMount feature gate is disabled, \\\"MountOption\\\" is used for ReadWriteOncePod volumes\\nand \\\"Recursive\\\" for all other volumes.\\n\\nThis field affects only Pods that have SELinux label set, either in PodSecurityContext or in SecurityContext of all containers.\\n\\nAll Pods that use the same volume should use the same seLinuxChangePolicy, otherwise some pods can get stuck in ContainerCreating state.\\nNote that this field cannot be set when spec.os.name is windows.\"", args=[d.arg(name='seLinuxChangePolicy', type=d.T.string)]),
          withSeLinuxChangePolicy(seLinuxChangePolicy): { spec+: { template+: { executor+: { podSecurityContext+: { seLinuxChangePolicy: seLinuxChangePolicy } } } } },
          '#withSupplementalGroups':: d.fn(help="\"A list of groups applied to the first process run in each container, in\\naddition to the container's primary GID and fsGroup (if specified).  If\\nthe SupplementalGroupsPolicy feature is enabled, the\\nsupplementalGroupsPolicy field determines whether these are in addition\\nto or instead of any group memberships defined in the container image.\\nIf unspecified, no additional groups are added, though group memberships\\ndefined in the container image may still be used, depending on the\\nsupplementalGroupsPolicy field.\\nNote that this field cannot be set when spec.os.name is windows.\"", args=[d.arg(name='supplementalGroups', type=d.T.array)]),
          withSupplementalGroups(supplementalGroups): { spec+: { template+: { executor+: { podSecurityContext+: { supplementalGroups: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } } },
          '#withSupplementalGroupsMixin':: d.fn(help="\"A list of groups applied to the first process run in each container, in\\naddition to the container's primary GID and fsGroup (if specified).  If\\nthe SupplementalGroupsPolicy feature is enabled, the\\nsupplementalGroupsPolicy field determines whether these are in addition\\nto or instead of any group memberships defined in the container image.\\nIf unspecified, no additional groups are added, though group memberships\\ndefined in the container image may still be used, depending on the\\nsupplementalGroupsPolicy field.\\nNote that this field cannot be set when spec.os.name is windows.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='supplementalGroups', type=d.T.array)]),
          withSupplementalGroupsMixin(supplementalGroups): { spec+: { template+: { executor+: { podSecurityContext+: { supplementalGroups+: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } } },
          '#withSupplementalGroupsPolicy':: d.fn(help='"Defines how supplemental groups of the first container processes are calculated.\\nValid values are \\"Merge\\" and \\"Strict\\". If not specified, \\"Merge\\" is used.\\n(Alpha) Using the field requires the SupplementalGroupsPolicy feature gate to be enabled\\nand the container runtime must implement support for this feature.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='supplementalGroupsPolicy', type=d.T.string)]),
          withSupplementalGroupsPolicy(supplementalGroupsPolicy): { spec+: { template+: { executor+: { podSecurityContext+: { supplementalGroupsPolicy: supplementalGroupsPolicy } } } } },
          '#withSysctls':: d.fn(help='"Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported\\nsysctls (by the container runtime) might fail to launch.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='sysctls', type=d.T.array)]),
          withSysctls(sysctls): { spec+: { template+: { executor+: { podSecurityContext+: { sysctls: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } } },
          '#withSysctlsMixin':: d.fn(help='"Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported\\nsysctls (by the container runtime) might fail to launch.\\nNote that this field cannot be set when spec.os.name is windows."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sysctls', type=d.T.array)]),
          withSysctlsMixin(sysctls): { spec+: { template+: { executor+: { podSecurityContext+: { sysctls+: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } } },
        },
        '#ports':: d.obj(help='"Ports settings for the pods, following the Kubernetes specifications."'),
        ports: {
          '#withContainerPort':: d.fn(help='', args=[d.arg(name='containerPort', type=d.T.integer)]),
        ...
        securityContext: {
          ...
          appArmorProfile: {
            '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used.\\nThe profile must be preconfigured on the node to work.\\nMust match the loaded name of the profile.\\nMust be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { template+: { executor+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied.\\nValid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { executor+: { securityContext+: { appArmorProfile+: { type: type } } } } } },
          },
          '#capabilities':: d.obj(help='"The capabilities to add/drop when running containers.\\nDefaults to the default set of capabilities granted by the container runtime.\\nNote that this field cannot be set when spec.os.name is windows."'),
          capabilities: {
            '#withAdd':: d.fn(help='"Added capabilities"', args=[d.arg(name='add', type=d.T.array)]),
            withAdd(add): { spec+: { template+: { executor+: { securityContext+: { capabilities+: { add: if std.isArray(v=add) then add else [add] } } } } } },
            '#withAddMixin':: d.fn(help='"Added capabilities"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='add', type=d.T.array)]),
            withAddMixin(add): { spec+: { template+: { executor+: { securityContext+: { capabilities+: { add+: if std.isArray(v=add) then add else [add] } } } } } },
            '#withDrop':: d.fn(help='"Removed capabilities"', args=[d.arg(name='drop', type=d.T.array)]),
            withDrop(drop): { spec+: { template+: { executor+: { securityContext+: { capabilities+: { drop: if std.isArray(v=drop) then drop else [drop] } } } } } },
            '#withDropMixin':: d.fn(help='"Removed capabilities"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='drop', type=d.T.array)]),
            withDropMixin(drop): { spec+: { template+: { executor+: { securityContext+: { capabilities+: { drop+: if std.isArray(v=drop) then drop else [drop] } } } } } },
          },
          '#seLinuxOptions':: d.obj(help='"The SELinux context to be applied to the container.\\nIf unspecified, the container runtime will allocate a random SELinux context for each\\ncontainer.  May also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."'),
          seLinuxOptions: {
            '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
            withLevel(level): { spec+: { template+: { executor+: { securityContext+: { seLinuxOptions+: { level: level } } } } } },
            '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
            withRole(role): { spec+: { template+: { executor+: { securityContext+: { seLinuxOptions+: { role: role } } } } } },
            '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { executor+: { securityContext+: { seLinuxOptions+: { type: type } } } } } },
            '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
            withUser(user): { spec+: { template+: { executor+: { securityContext+: { seLinuxOptions+: { user: user } } } } } },
          },
          '#seccompProfile':: d.obj(help='"The seccomp options to use by this container. If seccomp options are\\nprovided at both the pod & container level, the container options\\noverride the pod options.\\nNote that this field cannot be set when spec.os.name is windows."'),
          seccompProfile: {
            '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used.\\nThe profile must be preconfigured on the node to work.\\nMust be a descending path, relative to the kubelet's configured seccomp profile location.\\nMust be set if type is \\\"Localhost\\\". Must NOT be set for any other type.\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
            withLocalhostProfile(localhostProfile): { spec+: { template+: { executor+: { securityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } } } },
            '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied.\\nValid options are:\\n\\nLocalhost - a profile defined in a file on the node should be used.\\nRuntimeDefault - the container runtime default profile should be used.\\nUnconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { spec+: { template+: { executor+: { securityContext+: { seccompProfile+: { type: type } } } } } },
          },
          '#windowsOptions':: d.obj(help='"The Windows specific settings applied to all containers.\\nIf unspecified, the options from the PodSecurityContext will be used.\\nIf set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is linux."'),
          windowsOptions: {
            '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook\\n(https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the\\nGMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
            withGmsaCredentialSpec(gmsaCredentialSpec): { spec+: { template+: { executor+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } } },
            '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
            withGmsaCredentialSpecName(gmsaCredentialSpecName): { spec+: { template+: { executor+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } } },
            '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container.\\nAll of a Pod's containers must have the same effective HostProcess value\\n(it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).\\nIn addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
            withHostProcess(hostProcess): { spec+: { template+: { executor+: { securityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } } },
            '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process.\\nDefaults to the user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext. If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
            withRunAsUserName(runAsUserName): { spec+: { template+: { executor+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } } },
          },
          '#withAllowPrivilegeEscalation':: d.fn(help='"AllowPrivilegeEscalation controls whether a process can gain more\\nprivileges than its parent process. This bool directly controls if\\nthe no_new_privs flag will be set on the container process.\\nAllowPrivilegeEscalation is true always when the container is:\\n1) run as Privileged\\n2) has CAP_SYS_ADMIN\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='allowPrivilegeEscalation', type=d.T.boolean)]),
          withAllowPrivilegeEscalation(allowPrivilegeEscalation): { spec+: { template+: { executor+: { securityContext+: { allowPrivilegeEscalation: allowPrivilegeEscalation } } } } },
          '#withPrivileged':: d.fn(help='"Run container in privileged mode.\\nProcesses in privileged containers are essentially equivalent to root on the host.\\nDefaults to false.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='privileged', type=d.T.boolean)]),
          withPrivileged(privileged): { spec+: { template+: { executor+: { securityContext+: { privileged: privileged } } } } },
          '#withProcMount':: d.fn(help='"procMount denotes the type of proc mount to use for the containers.\\nThe default value is Default which uses the container runtime defaults for\\nreadonly paths and masked paths.\\nThis requires the ProcMountType feature flag to be enabled.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='procMount', type=d.T.string)]),
          withProcMount(procMount): { spec+: { template+: { executor+: { securityContext+: { procMount: procMount } } } } },
          '#withReadOnlyRootFilesystem':: d.fn(help='"Whether this container has a read-only root filesystem.\\nDefault is false.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='readOnlyRootFilesystem', type=d.T.boolean)]),
          withReadOnlyRootFilesystem(readOnlyRootFilesystem): { spec+: { template+: { executor+: { securityContext+: { readOnlyRootFilesystem: readOnlyRootFilesystem } } } } },
          '#withRunAsGroup':: d.fn(help='"The GID to run the entrypoint of the container process.\\nUses runtime default if unset.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
          withRunAsGroup(runAsGroup): { spec+: { template+: { executor+: { securityContext+: { runAsGroup: runAsGroup } } } } },
          '#withRunAsNonRoot':: d.fn(help='"Indicates that the container must run as a non-root user.\\nIf true, the Kubelet will validate the image at runtime to ensure that it\\ndoes not run as UID 0 (root) and fail to start the container if it does.\\nIf unset or false, no such validation will be performed.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
          withRunAsNonRoot(runAsNonRoot): { spec+: { template+: { executor+: { securityContext+: { runAsNonRoot: runAsNonRoot } } } } },
          '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process.\\nDefaults to user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
          withRunAsUser(runAsUser): { spec+: { template+: { executor+: { securityContext+: { runAsUser: runAsUser } } } } },
        },
        '#sidecars':: d.obj(help='"Sidecars is a list of sidecar containers that run along side the main Spark container."'),
        sidecars: {
          '#env':: d.obj(help='"List of environment variables to set in the container.\\nCannot be updated."'),
        ...
        '#withAnnotations':: d.fn(help='"Annotations are the Kubernetes annotations to be added to the pod."', args=[d.arg(name='annotations', type=d.T.object)]),
        withAnnotations(annotations): { spec+: { template+: { executor+: { annotations: annotations } } } },
        '#withAnnotationsMixin':: d.fn(help='"Annotations are the Kubernetes annotations to be added to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
        withAnnotationsMixin(annotations): { spec+: { template+: { executor+: { annotations+: annotations } } } },
        '#withConfigMaps':: d.fn(help='"ConfigMaps carries information of other ConfigMaps to add to the pod."', args=[d.arg(name='configMaps', type=d.T.array)]),
        withConfigMaps(configMaps): { spec+: { template+: { executor+: { configMaps: if std.isArray(v=configMaps) then configMaps else [configMaps] } } } },
        '#withConfigMapsMixin':: d.fn(help='"ConfigMaps carries information of other ConfigMaps to add to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='configMaps', type=d.T.array)]),
        withConfigMapsMixin(configMaps): { spec+: { template+: { executor+: { configMaps+: if std.isArray(v=configMaps) then configMaps else [configMaps] } } } },
        '#withCoreLimit':: d.fn(help='"CoreLimit specifies a hard limit on CPU cores for the pod.\\nOptional"', args=[d.arg(name='coreLimit', type=d.T.string)]),
        withCoreLimit(coreLimit): { spec+: { template+: { executor+: { coreLimit: coreLimit } } } },
        '#withCoreRequest':: d.fn(help='"CoreRequest is the physical CPU core request for the executors.\\nMaps to `spark.kubernetes.executor.request.cores` that is available since Spark 2.4."', args=[d.arg(name='coreRequest', type=d.T.string)]),
        withCoreRequest(coreRequest): { spec+: { template+: { executor+: { coreRequest: coreRequest } } } },
        '#withCores':: d.fn(help='"Cores maps to `spark.driver.cores` or `spark.executor.cores` for the driver and executors, respectively."', args=[d.arg(name='cores', type=d.T.integer)]),
        withCores(cores): { spec+: { template+: { executor+: { cores: cores } } } },
        '#withDeleteOnTermination':: d.fn(help='"DeleteOnTermination specify whether executor pods should be deleted in case of failure or normal termination.\\nMaps to `spark.kubernetes.executor.deleteOnTermination` that is available since Spark 3.0."', args=[d.arg(name='deleteOnTermination', type=d.T.boolean)]),
        withDeleteOnTermination(deleteOnTermination): { spec+: { template+: { executor+: { deleteOnTermination: deleteOnTermination } } } },
        '#withEnv':: d.fn(help='"Env carries the environment variables to add to the pod."', args=[d.arg(name='env', type=d.T.array)]),
        withEnv(env): { spec+: { template+: { executor+: { env: if std.isArray(v=env) then env else [env] } } } },
        '#withEnvFrom':: d.fn(help='"EnvFrom is a list of sources to populate environment variables in the container."', args=[d.arg(name='envFrom', type=d.T.array)]),
        withEnvFrom(envFrom): { spec+: { template+: { executor+: { envFrom: if std.isArray(v=envFrom) then envFrom else [envFrom] } } } },
        '#withEnvFromMixin':: d.fn(help='"EnvFrom is a list of sources to populate environment variables in the container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envFrom', type=d.T.array)]),
        withEnvFromMixin(envFrom): { spec+: { template+: { executor+: { envFrom+: if std.isArray(v=envFrom) then envFrom else [envFrom] } } } },
        '#withEnvMixin':: d.fn(help='"Env carries the environment variables to add to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='env', type=d.T.array)]),
        withEnvMixin(env): { spec+: { template+: { executor+: { env+: if std.isArray(v=env) then env else [env] } } } },
        '#withEnvSecretKeyRefs':: d.fn(help='"EnvSecretKeyRefs holds a mapping from environment variable names to SecretKeyRefs.\\nDeprecated. Consider using `env` instead."', args=[d.arg(name='envSecretKeyRefs', type=d.T.object)]),
        withEnvSecretKeyRefs(envSecretKeyRefs): { spec+: { template+: { executor+: { envSecretKeyRefs: envSecretKeyRefs } } } },
        '#withEnvSecretKeyRefsMixin':: d.fn(help='"EnvSecretKeyRefs holds a mapping from environment variable names to SecretKeyRefs.\\nDeprecated. Consider using `env` instead."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envSecretKeyRefs', type=d.T.object)]),
        withEnvSecretKeyRefsMixin(envSecretKeyRefs): { spec+: { template+: { executor+: { envSecretKeyRefs+: envSecretKeyRefs } } } },
        '#withEnvVars':: d.fn(help='"EnvVars carries the environment variables to add to the pod.\\nDeprecated. Consider using `env` instead."', args=[d.arg(name='envVars', type=d.T.object)]),
        withEnvVars(envVars): { spec+: { template+: { executor+: { envVars: envVars } } } },
        '#withEnvVarsMixin':: d.fn(help='"EnvVars carries the environment variables to add to the pod.\\nDeprecated. Consider using `env` instead."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envVars', type=d.T.object)]),
        withEnvVarsMixin(envVars): { spec+: { template+: { executor+: { envVars+: envVars } } } },
        '#withHostAliases':: d.fn(help='"HostAliases settings for the pod, following the Kubernetes specifications."', args=[d.arg(name='hostAliases', type=d.T.array)]),
        withHostAliases(hostAliases): { spec+: { template+: { executor+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } } },
        '#withHostAliasesMixin':: d.fn(help='"HostAliases settings for the pod, following the Kubernetes specifications."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hostAliases', type=d.T.array)]),
        withHostAliasesMixin(hostAliases): { spec+: { template+: { executor+: { hostAliases+: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } } },
        '#withHostNetwork':: d.fn(help='"HostNetwork indicates whether to request host networking for the pod or not."', args=[d.arg(name='hostNetwork', type=d.T.boolean)]),
        withHostNetwork(hostNetwork): { spec+: { template+: { executor+: { hostNetwork: hostNetwork } } } },
        '#withImage':: d.fn(help='"Image is the container image to use. Overrides Spec.Image if set."', args=[d.arg(name='image', type=d.T.string)]),
        withImage(image): { spec+: { template+: { executor+: { image: image } } } },
        '#withInitContainers':: d.fn(help='"InitContainers is a list of init-containers that run to completion before the main Spark container."', args=[d.arg(name='initContainers', type=d.T.array)]),
        withInitContainers(initContainers): { spec+: { template+: { executor+: { initContainers: if std.isArray(v=initContainers) then initContainers else [initContainers] } } } },
        '#withInitContainersMixin':: d.fn(help='"InitContainers is a list of init-containers that run to completion before the main Spark container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='initContainers', type=d.T.array)]),
        withInitContainersMixin(initContainers): { spec+: { template+: { executor+: { initContainers+: if std.isArray(v=initContainers) then initContainers else [initContainers] } } } },
        '#withInstances':: d.fn(help='"Instances is the number of executor instances."', args=[d.arg(name='instances', type=d.T.integer)]),
        withInstances(instances): { spec+: { template+: { executor+: { instances: instances } } } },
        '#withJavaOptions':: d.fn(help='"JavaOptions is a string of extra JVM options to pass to the executors. For instance,\\nGC settings or other logging."', args=[d.arg(name='javaOptions', type=d.T.string)]),
        withJavaOptions(javaOptions): { spec+: { template+: { executor+: { javaOptions: javaOptions } } } },
        '#withLabels':: d.fn(help='"Labels are the Kubernetes labels to be added to the pod."', args=[d.arg(name='labels', type=d.T.object)]),
        withLabels(labels): { spec+: { template+: { executor+: { labels: labels } } } },
        '#withLabelsMixin':: d.fn(help='"Labels are the Kubernetes labels to be added to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
        withLabelsMixin(labels): { spec+: { template+: { executor+: { labels+: labels } } } },
        '#withMemory':: d.fn(help='"Memory is the amount of memory to request for the pod."', args=[d.arg(name='memory', type=d.T.string)]),
        withMemory(memory): { spec+: { template+: { executor+: { memory: memory } } } },
        '#withMemoryLimit':: d.fn(help='"MemoryLimit overrides the memory limit of the pod."', args=[d.arg(name='memoryLimit', type=d.T.string)]),
        withMemoryLimit(memoryLimit): { spec+: { template+: { executor+: { memoryLimit: memoryLimit } } } },
        '#withMemoryOverhead':: d.fn(help='"MemoryOverhead is the amount of off-heap memory to allocate in cluster mode, in MiB unless otherwise specified."', args=[d.arg(name='memoryOverhead', type=d.T.string)]),
        withMemoryOverhead(memoryOverhead): { spec+: { template+: { executor+: { memoryOverhead: memoryOverhead } } } },
        '#withNodeSelector':: d.fn(help='"NodeSelector is the Kubernetes node selector to be added to the driver and executor pods.\\nThis field is mutually exclusive with nodeSelector at SparkApplication level (which will be deprecated)."', args=[d.arg(name='nodeSelector', type=d.T.object)]),
        withNodeSelector(nodeSelector): { spec+: { template+: { executor+: { nodeSelector: nodeSelector } } } },
        '#withNodeSelectorMixin':: d.fn(help='"NodeSelector is the Kubernetes node selector to be added to the driver and executor pods.\\nThis field is mutually exclusive with nodeSelector at SparkApplication level (which will be deprecated)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeSelector', type=d.T.object)]),
        withNodeSelectorMixin(nodeSelector): { spec+: { template+: { executor+: { nodeSelector+: nodeSelector } } } },
        '#withPorts':: d.fn(help='"Ports settings for the pods, following the Kubernetes specifications."', args=[d.arg(name='ports', type=d.T.array)]),
        withPorts(ports): { spec+: { template+: { executor+: { ports: if std.isArray(v=ports) then ports else [ports] } } } },
        '#withPortsMixin':: d.fn(help='"Ports settings for the pods, following the Kubernetes specifications."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ports', type=d.T.array)]),
        withPortsMixin(ports): { spec+: { template+: { executor+: { ports+: if std.isArray(v=ports) then ports else [ports] } } } },
        '#withPriorityClassName':: d.fn(help='"PriorityClassName is the name of the PriorityClass for the executor pod."', args=[d.arg(name='priorityClassName', type=d.T.string)]),
        withPriorityClassName(priorityClassName): { spec+: { template+: { executor+: { priorityClassName: priorityClassName } } } },
        '#withSchedulerName':: d.fn(help='"SchedulerName specifies the scheduler that will be used for scheduling"', args=[d.arg(name='schedulerName', type=d.T.string)]),
        withSchedulerName(schedulerName): { spec+: { template+: { executor+: { schedulerName: schedulerName } } } },
        '#withSecrets':: d.fn(help='"Secrets carries information of secrets to add to the pod."', args=[d.arg(name='secrets', type=d.T.array)]),
        withSecrets(secrets): { spec+: { template+: { executor+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } } } },
        '#withSecretsMixin':: d.fn(help='"Secrets carries information of secrets to add to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.array)]),
        withSecretsMixin(secrets): { spec+: { template+: { executor+: { secrets+: if std.isArray(v=secrets) then secrets else [secrets] } } } },
        '#withServiceAccount':: d.fn(help='"ServiceAccount is the name of the custom Kubernetes service account used by the pod."', args=[d.arg(name='serviceAccount', type=d.T.string)]),
        withServiceAccount(serviceAccount): { spec+: { template+: { executor+: { serviceAccount: serviceAccount } } } },
        '#withShareProcessNamespace':: d.fn(help='"ShareProcessNamespace settings for the pod, following the Kubernetes specifications."', args=[d.arg(name='shareProcessNamespace', type=d.T.boolean)]),
        withShareProcessNamespace(shareProcessNamespace): { spec+: { template+: { executor+: { shareProcessNamespace: shareProcessNamespace } } } },
        '#withSidecars':: d.fn(help='"Sidecars is a list of sidecar containers that run along side the main Spark container."', args=[d.arg(name='sidecars', type=d.T.array)]),
        withSidecars(sidecars): { spec+: { template+: { executor+: { sidecars: if std.isArray(v=sidecars) then sidecars else [sidecars] } } } },
        '#withSidecarsMixin':: d.fn(help='"Sidecars is a list of sidecar containers that run along side the main Spark container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sidecars', type=d.T.array)]),
        withSidecarsMixin(sidecars): { spec+: { template+: { executor+: { sidecars+: if std.isArray(v=sidecars) then sidecars else [sidecars] } } } },
        '#withTemplate':: d.fn(help='"Template is a pod template that can be used to define the driver or executor pod configurations that Spark configurations do not support.\\nSpark version >= 3.0.0 is required.\\nRef: https://spark.apache.org/docs/latest/running-on-kubernetes.html#pod-template."', args=[d.arg(name='template', type=d.T.object)]),
        withTemplate(template): { spec+: { template+: { executor+: { template: template } } } },
        '#withTemplateMixin':: d.fn(help='"Template is a pod template that can be used to define the driver or executor pod configurations that Spark configurations do not support.\\nSpark version >= 3.0.0 is required.\\nRef: https://spark.apache.org/docs/latest/running-on-kubernetes.html#pod-template."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='template', type=d.T.object)]),
        withTemplateMixin(template): { spec+: { template+: { executor+: { template+: template } } } },
        '#withTerminationGracePeriodSeconds':: d.fn(help='"Termination grace period seconds for the pod"', args=[d.arg(name='terminationGracePeriodSeconds', type=d.T.integer)]),
        withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { spec+: { template+: { executor+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } } },
        '#withTolerations':: d.fn(help='"Tolerations specifies the tolerations listed in \\".spec.tolerations\\" to be applied to the pod."', args=[d.arg(name='tolerations', type=d.T.array)]),
        withTolerations(tolerations): { spec+: { template+: { executor+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } } } },
        '#withTolerationsMixin':: d.fn(help='"Tolerations specifies the tolerations listed in \\".spec.tolerations\\" to be applied to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tolerations', type=d.T.array)]),
        withTolerationsMixin(tolerations): { spec+: { template+: { executor+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } } } },
        '#withVolumeMounts':: d.fn(help="\"VolumeMounts specifies the volumes listed in \\\".spec.volumes\\\" to mount into the main container's filesystem.\"", args=[d.arg(name='volumeMounts', type=d.T.array)]),
        withVolumeMounts(volumeMounts): { spec+: { template+: { executor+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
        '#withVolumeMountsMixin':: d.fn(help="\"VolumeMounts specifies the volumes listed in \\\".spec.volumes\\\" to mount into the main container's filesystem.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='volumeMounts', type=d.T.array)]),
        withVolumeMountsMixin(volumeMounts): { spec+: { template+: { executor+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } } },
      },
      '#monitoring':: d.obj(help='"Monitoring configures how monitoring is handled."'),
      monitoring: {
        '#prometheus':: d.obj(help='"Prometheus is for configuring the Prometheus JMX exporter."'),
        prometheus: {
          '#withConfigFile':: d.fn(help='"ConfigFile is the path to the custom Prometheus configuration file provided in the Spark image.\\nConfigFile takes precedence over Configuration, which is shown below."', args=[d.arg(name='configFile', type=d.T.string)]),
          withConfigFile(configFile): { spec+: { template+: { monitoring+: { prometheus+: { configFile: configFile } } } } },
          '#withConfiguration':: d.fn(help='"Configuration is the content of the Prometheus configuration needed by the Prometheus JMX exporter.\\nIf not specified, the content in spark-docker/conf/prometheus.yaml will be used.\\nConfiguration has no effect if ConfigFile is set."', args=[d.arg(name='configuration', type=d.T.string)]),
          withConfiguration(configuration): { spec+: { template+: { monitoring+: { prometheus+: { configuration: configuration } } } } },
          '#withJmxExporterJar':: d.fn(help='"JmxExporterJar is the path to the Prometheus JMX exporter jar in the container."', args=[d.arg(name='jmxExporterJar', type=d.T.string)]),
          withJmxExporterJar(jmxExporterJar): { spec+: { template+: { monitoring+: { prometheus+: { jmxExporterJar: jmxExporterJar } } } } },
          '#withPort':: d.fn(help='"Port is the port of the HTTP server run by the Prometheus JMX exporter.\\nIf not specified, 8090 will be used as the default."', args=[d.arg(name='port', type=d.T.integer)]),
          withPort(port): { spec+: { template+: { monitoring+: { prometheus+: { port: port } } } } },
          '#withPortName':: d.fn(help='"PortName is the port name of prometheus JMX exporter port.\\nIf not specified, jmx-exporter will be used as the default."', args=[d.arg(name='portName', type=d.T.string)]),
          withPortName(portName): { spec+: { template+: { monitoring+: { prometheus+: { portName: portName } } } } },
        },
        '#withExposeDriverMetrics':: d.fn(help='"ExposeDriverMetrics specifies whether to expose metrics on the driver."', args=[d.arg(name='exposeDriverMetrics', type=d.T.boolean)]),
        withExposeDriverMetrics(exposeDriverMetrics): { spec+: { template+: { monitoring+: { exposeDriverMetrics: exposeDriverMetrics } } } },
        '#withExposeExecutorMetrics':: d.fn(help='"ExposeExecutorMetrics specifies whether to expose metrics on the executors."', args=[d.arg(name='exposeExecutorMetrics', type=d.T.boolean)]),
        withExposeExecutorMetrics(exposeExecutorMetrics): { spec+: { template+: { monitoring+: { exposeExecutorMetrics: exposeExecutorMetrics } } } },
        '#withMetricsProperties':: d.fn(help='"MetricsProperties is the content of a custom metrics.properties for configuring the Spark metric system.\\nIf not specified, the content in spark-docker/conf/metrics.properties will be used."', args=[d.arg(name='metricsProperties', type=d.T.string)]),
        withMetricsProperties(metricsProperties): { spec+: { template+: { monitoring+: { metricsProperties: metricsProperties } } } },
        '#withMetricsPropertiesFile':: d.fn(help='"MetricsPropertiesFile is the container local path of file metrics.properties for configuring\\nthe Spark metric system. If not specified, value /etc/metrics/conf/metrics.properties will be used."', args=[d.arg(name='metricsPropertiesFile', type=d.T.string)]),
        withMetricsPropertiesFile(metricsPropertiesFile): { spec+: { template+: { monitoring+: { metricsPropertiesFile: metricsPropertiesFile } } } },
      },
      '#restartPolicy':: d.obj(help='"RestartPolicy defines the policy on if and in which conditions the controller should restart an application."'),
      restartPolicy: {
        '#withOnFailureRetries':: d.fn(help='"OnFailureRetries the number of times to retry running an application before giving up."', args=[d.arg(name='onFailureRetries', type=d.T.integer)]),
        withOnFailureRetries(onFailureRetries): { spec+: { template+: { restartPolicy+: { onFailureRetries: onFailureRetries } } } },
        '#withOnFailureRetryInterval':: d.fn(help='"OnFailureRetryInterval is the interval in seconds between retries on failed runs."', args=[d.arg(name='onFailureRetryInterval', type=d.T.integer)]),
        withOnFailureRetryInterval(onFailureRetryInterval): { spec+: { template+: { restartPolicy+: { onFailureRetryInterval: onFailureRetryInterval } } } },
        '#withOnSubmissionFailureRetries':: d.fn(help='"OnSubmissionFailureRetries is the number of times to retry submitting an application before giving up.\\nThis is best effort and actual retry attempts can be >= the value specified due to caching.\\nThese are required if RestartPolicy is OnFailure."', args=[d.arg(name='onSubmissionFailureRetries', type=d.T.integer)]),
        withOnSubmissionFailureRetries(onSubmissionFailureRetries): { spec+: { template+: { restartPolicy+: { onSubmissionFailureRetries: onSubmissionFailureRetries } } } },
        '#withOnSubmissionFailureRetryInterval':: d.fn(help='"OnSubmissionFailureRetryInterval is the interval in seconds between retries on failed submissions."', args=[d.arg(name='onSubmissionFailureRetryInterval', type=d.T.integer)]),
        withOnSubmissionFailureRetryInterval(onSubmissionFailureRetryInterval): { spec+: { template+: { restartPolicy+: { onSubmissionFailureRetryInterval: onSubmissionFailureRetryInterval } } } },
        '#withType':: d.fn(help='"Type specifies the RestartPolicyType."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { spec+: { template+: { restartPolicy+: { type: type } } } },
      },
      '#sparkUIOptions':: d.obj(help='"SparkUIOptions allows configuring the Service and the Ingress to expose the sparkUI"'),
      sparkUIOptions: {
        '#ingressTLS':: d.obj(help='"TlsHosts is useful If we need to declare SSL certificates to the ingress object"'),
        ingressTLS: {
          '#withHosts':: d.fn(help='"hosts is a list of hosts included in the TLS certificate. The values in\\nthis list must match the name/s used in the tlsSecret. Defaults to the\\nwildcard host setting for the loadbalancer controller fulfilling this\\nIngress, if left unspecified."', args=[d.arg(name='hosts', type=d.T.array)]),
        ...
        '#withIngressAnnotations':: d.fn(help='"IngressAnnotations is a map of key,value pairs of annotations that might be added to the ingress object. i.e. specify nginx as ingress.class"', args=[d.arg(name='ingressAnnotations', type=d.T.object)]),
        withIngressAnnotations(ingressAnnotations): { spec+: { template+: { sparkUIOptions+: { ingressAnnotations: ingressAnnotations } } } },
        '#withIngressAnnotationsMixin':: d.fn(help='"IngressAnnotations is a map of key,value pairs of annotations that might be added to the ingress object. i.e. specify nginx as ingress.class"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ingressAnnotations', type=d.T.object)]),
        withIngressAnnotationsMixin(ingressAnnotations): { spec+: { template+: { sparkUIOptions+: { ingressAnnotations+: ingressAnnotations } } } },
        '#withIngressTLS':: d.fn(help='"TlsHosts is useful If we need to declare SSL certificates to the ingress object"', args=[d.arg(name='ingressTLS', type=d.T.array)]),
        withIngressTLS(ingressTLS): { spec+: { template+: { sparkUIOptions+: { ingressTLS: if std.isArray(v=ingressTLS) then ingressTLS else [ingressTLS] } } } },
        '#withIngressTLSMixin':: d.fn(help='"TlsHosts is useful If we need to declare SSL certificates to the ingress object"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ingressTLS', type=d.T.array)]),
        withIngressTLSMixin(ingressTLS): { spec+: { template+: { sparkUIOptions+: { ingressTLS+: if std.isArray(v=ingressTLS) then ingressTLS else [ingressTLS] } } } },
        '#withServiceAnnotations':: d.fn(help='"ServiceAnnotations is a map of key,value pairs of annotations that might be added to the service object."', args=[d.arg(name='serviceAnnotations', type=d.T.object)]),
        withServiceAnnotations(serviceAnnotations): { spec+: { template+: { sparkUIOptions+: { serviceAnnotations: serviceAnnotations } } } },
        '#withServiceAnnotationsMixin':: d.fn(help='"ServiceAnnotations is a map of key,value pairs of annotations that might be added to the service object."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceAnnotations', type=d.T.object)]),
        withServiceAnnotationsMixin(serviceAnnotations): { spec+: { template+: { sparkUIOptions+: { serviceAnnotations+: serviceAnnotations } } } },
        '#withServiceLabels':: d.fn(help='"ServiceLabels is a map of key,value pairs of labels that might be added to the service object."', args=[d.arg(name='serviceLabels', type=d.T.object)]),
        withServiceLabels(serviceLabels): { spec+: { template+: { sparkUIOptions+: { serviceLabels: serviceLabels } } } },
        '#withServiceLabelsMixin':: d.fn(help='"ServiceLabels is a map of key,value pairs of labels that might be added to the service object."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceLabels', type=d.T.object)]),
        withServiceLabelsMixin(serviceLabels): { spec+: { template+: { sparkUIOptions+: { serviceLabels+: serviceLabels } } } },
        '#withServicePort':: d.fn(help='"ServicePort allows configuring the port at service level that might be different from the targetPort.\\nTargetPort should be the same as the one defined in spark.ui.port"', args=[d.arg(name='servicePort', type=d.T.integer)]),
        withServicePort(servicePort): { spec+: { template+: { sparkUIOptions+: { servicePort: servicePort } } } },
        '#withServicePortName':: d.fn(help='"ServicePortName allows configuring the name of the service port.\\nThis may be useful for sidecar proxies like Envoy injected by Istio which require specific ports names to treat traffic as proper HTTP.\\nDefaults to spark-driver-ui-port."', args=[d.arg(name='servicePortName', type=d.T.string)]),
        withServicePortName(servicePortName): { spec+: { template+: { sparkUIOptions+: { servicePortName: servicePortName } } } },
        '#withServiceType':: d.fn(help='"ServiceType allows configuring the type of the service. Defaults to ClusterIP."', args=[d.arg(name='serviceType', type=d.T.string)]),
        withServiceType(serviceType): { spec+: { template+: { sparkUIOptions+: { serviceType: serviceType } } } },
      },
      '#volumes':: d.obj(help='"Volumes is the list of Kubernetes volumes that can be mounted by the driver and/or executors."'),
      volumes: {
      ...
      '#withArguments':: d.fn(help='"Arguments is a list of arguments to be passed to the application."', args=[d.arg(name='arguments', type=d.T.array)]),
      withArguments(arguments): { spec+: { template+: { arguments: if std.isArray(v=arguments) then arguments else [arguments] } } },
      '#withArgumentsMixin':: d.fn(help='"Arguments is a list of arguments to be passed to the application."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='arguments', type=d.T.array)]),
      withArgumentsMixin(arguments): { spec+: { template+: { arguments+: if std.isArray(v=arguments) then arguments else [arguments] } } },
      '#withBatchScheduler':: d.fn(help='"BatchScheduler configures which batch scheduler will be used for scheduling"', args=[d.arg(name='batchScheduler', type=d.T.string)]),
      withBatchScheduler(batchScheduler): { spec+: { template+: { batchScheduler: batchScheduler } } },
      '#withDriverIngressOptions':: d.fn(help='"DriverIngressOptions allows configuring the Service and the Ingress to expose ports inside Spark Driver"', args=[d.arg(name='driverIngressOptions', type=d.T.array)]),
      withDriverIngressOptions(driverIngressOptions): { spec+: { template+: { driverIngressOptions: if std.isArray(v=driverIngressOptions) then driverIngressOptions else [driverIngressOptions] } } },
      '#withDriverIngressOptionsMixin':: d.fn(help='"DriverIngressOptions allows configuring the Service and the Ingress to expose ports inside Spark Driver"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='driverIngressOptions', type=d.T.array)]),
      withDriverIngressOptionsMixin(driverIngressOptions): { spec+: { template+: { driverIngressOptions+: if std.isArray(v=driverIngressOptions) then driverIngressOptions else [driverIngressOptions] } } },
      '#withFailureRetries':: d.fn(help='"FailureRetries is the number of times to retry a failed application before giving up.\\nThis is best effort and actual retry attempts can be >= the value specified."', args=[d.arg(name='failureRetries', type=d.T.integer)]),
      withFailureRetries(failureRetries): { spec+: { template+: { failureRetries: failureRetries } } },
      '#withHadoopConf':: d.fn(help='"HadoopConf carries user-specified Hadoop configuration properties as they would use the \\"--conf\\" option\\nin spark-submit. The SparkApplication controller automatically adds prefix \\"spark.hadoop.\\" to Hadoop\\nconfiguration properties."', args=[d.arg(name='hadoopConf', type=d.T.object)]),
      withHadoopConf(hadoopConf): { spec+: { template+: { hadoopConf: hadoopConf } } },
      '#withHadoopConfMixin':: d.fn(help='"HadoopConf carries user-specified Hadoop configuration properties as they would use the \\"--conf\\" option\\nin spark-submit. The SparkApplication controller automatically adds prefix \\"spark.hadoop.\\" to Hadoop\\nconfiguration properties."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hadoopConf', type=d.T.object)]),
      withHadoopConfMixin(hadoopConf): { spec+: { template+: { hadoopConf+: hadoopConf } } },
      '#withHadoopConfigMap':: d.fn(help='"HadoopConfigMap carries the name of the ConfigMap containing Hadoop configuration files such as core-site.xml.\\nThe controller will add environment variable HADOOP_CONF_DIR to the path where the ConfigMap is mounted to."', args=[d.arg(name='hadoopConfigMap', type=d.T.string)]),
      withHadoopConfigMap(hadoopConfigMap): { spec+: { template+: { hadoopConfigMap: hadoopConfigMap } } },
      '#withImage':: d.fn(help='"Image is the container image for the driver, executor, and init-container. Any custom container images for the\\ndriver, executor, or init-container takes precedence over this."', args=[d.arg(name='image', type=d.T.string)]),
      withImage(image): { spec+: { template+: { image: image } } },
      '#withImagePullPolicy':: d.fn(help='"ImagePullPolicy is the image pull policy for the driver, executor, and init-container."', args=[d.arg(name='imagePullPolicy', type=d.T.string)]),
      withImagePullPolicy(imagePullPolicy): { spec+: { template+: { imagePullPolicy: imagePullPolicy } } },
      '#withImagePullSecrets':: d.fn(help='"ImagePullSecrets is the list of image-pull secrets."', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
      ...
      '#withMainApplicationFile':: d.fn(help='"MainFile is the path to a bundled JAR, Python, or R file of the application."', args=[d.arg(name='mainApplicationFile', type=d.T.string)]),
      withMainApplicationFile(mainApplicationFile): { spec+: { template+: { mainApplicationFile: mainApplicationFile } } },
      '#withMainClass':: d.fn(help='"MainClass is the fully-qualified main class of the Spark application.\\nThis only applies to Java/Scala Spark applications."', args=[d.arg(name='mainClass', type=d.T.string)]),
      withMainClass(mainClass): { spec+: { template+: { mainClass: mainClass } } },
      '#withMemoryOverheadFactor':: d.fn(help='"This sets the Memory Overhead Factor that will allocate memory to non-JVM memory.\\nFor JVM-based jobs this value will default to 0.10, for non-JVM jobs 0.40. Value of this field will\\nbe overridden by `Spec.Driver.MemoryOverhead` and `Spec.Executor.MemoryOverhead` if they are set."', args=[d.arg(name='memoryOverheadFactor', type=d.T.string)]),
      withMemoryOverheadFactor(memoryOverheadFactor): { spec+: { template+: { memoryOverheadFactor: memoryOverheadFactor } } },
      '#withMode':: d.fn(help='"Mode is the deployment mode of the Spark application."', args=[d.arg(name='mode', type=d.T.string)]),
      withMode(mode): { spec+: { template+: { mode: mode } } },
      '#withNodeSelector':: d.fn(help='"NodeSelector is the Kubernetes node selector to be added to the driver and executor pods.\\nThis field is mutually exclusive with nodeSelector at podSpec level (driver or executor).\\nThis field will be deprecated in future versions (at SparkApplicationSpec level)."', args=[d.arg(name='nodeSelector', type=d.T.object)]),
      ...
      '#withProxyUser':: d.fn(help='"ProxyUser specifies the user to impersonate when submitting the application.\\nIt maps to the command-line flag \\"--proxy-user\\" in spark-submit."', args=[d.arg(name='proxyUser', type=d.T.string)]),
      withProxyUser(proxyUser): { spec+: { template+: { proxyUser: proxyUser } } },
      '#withPythonVersion':: d.fn(help='"This sets the major Python version of the docker\\nimage used to run the driver and executor containers. Can either be 2 or 3, default 2."', args=[d.arg(name='pythonVersion', type=d.T.string)]),
      withPythonVersion(pythonVersion): { spec+: { template+: { pythonVersion: pythonVersion } } },
      '#withRetryInterval':: d.fn(help='"RetryInterval is the unit of intervals in seconds between submission retries."', args=[d.arg(name='retryInterval', type=d.T.integer)]),
      withRetryInterval(retryInterval): { spec+: { template+: { retryInterval: retryInterval } } },
      '#withSparkConf':: d.fn(help='"SparkConf carries user-specified Spark configuration properties as they would use the  \\"--conf\\" option in\\nspark-submit."', args=[d.arg(name='sparkConf', type=d.T.object)]),
      withSparkConf(sparkConf): { spec+: { template+: { sparkConf: sparkConf } } },
      '#withSparkConfMixin':: d.fn(help='"SparkConf carries user-specified Spark configuration properties as they would use the  \\"--conf\\" option in\\nspark-submit."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sparkConf', type=d.T.object)]),
      withSparkConfMixin(sparkConf): { spec+: { template+: { sparkConf+: sparkConf } } },
      '#withSparkConfigMap':: d.fn(help='"SparkConfigMap carries the name of the ConfigMap containing Spark configuration files such as log4j.properties.\\nThe controller will add environment variable SPARK_CONF_DIR to the path where the ConfigMap is mounted to."', args=[d.arg(name='sparkConfigMap', type=d.T.string)]),
      withSparkConfigMap(sparkConfigMap): { spec+: { template+: { sparkConfigMap: sparkConfigMap } } },
      '#withSparkVersion':: d.fn(help='"SparkVersion is the version of Spark the application uses."', args=[d.arg(name='sparkVersion', type=d.T.string)]),
      withSparkVersion(sparkVersion): { spec+: { template+: { sparkVersion: sparkVersion } } },
      '#withTimeToLiveSeconds':: d.fn(help='"TimeToLiveSeconds defines the Time-To-Live (TTL) duration in seconds for this SparkApplication\\nafter its termination.\\nThe SparkApplication object will be garbage collected if the current time is more than the\\nTimeToLiveSeconds since its termination."', args=[d.arg(name='timeToLiveSeconds', type=d.T.integer)]),
      withTimeToLiveSeconds(timeToLiveSeconds): { spec+: { template+: { timeToLiveSeconds: timeToLiveSeconds } } },
      '#withType':: d.fn(help='"Type tells the type of the Spark application."', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { template+: { type: type } } },
      '#withVolumes':: d.fn(help='"Volumes is the list of Kubernetes volumes that can be mounted by the driver and/or executors."', args=[d.arg(name='volumes', type=d.T.array)]),
      withVolumes(volumes): { spec+: { template+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } } },
      '#withVolumesMixin':: d.fn(help='"Volumes is the list of Kubernetes volumes that can be mounted by the driver and/or executors."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumes', type=d.T.array)]),
      withVolumesMixin(volumes): { spec+: { template+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } } },
    },
    '#withConcurrencyPolicy':: d.fn(help='"ConcurrencyPolicy is the policy governing concurrent SparkApplication runs."', args=[d.arg(name='concurrencyPolicy', type=d.T.string)]),
    withConcurrencyPolicy(concurrencyPolicy): { spec+: { concurrencyPolicy: concurrencyPolicy } },
    '#withFailedRunHistoryLimit':: d.fn(help='"FailedRunHistoryLimit is the number of past failed runs of the application to keep.\\nDefaults to 1."', args=[d.arg(name='failedRunHistoryLimit', type=d.T.integer)]),
    withFailedRunHistoryLimit(failedRunHistoryLimit): { spec+: { failedRunHistoryLimit: failedRunHistoryLimit } },
    '#withSchedule':: d.fn(help='"Schedule is a cron schedule on which the application should run."', args=[d.arg(name='schedule', type=d.T.string)]),
    withSchedule(schedule): { spec+: { schedule: schedule } },
    '#withSuccessfulRunHistoryLimit':: d.fn(help='"SuccessfulRunHistoryLimit is the number of past successful runs of the application to keep.\\nDefaults to 1."', args=[d.arg(name='successfulRunHistoryLimit', type=d.T.integer)]),
    withSuccessfulRunHistoryLimit(successfulRunHistoryLimit): { spec+: { successfulRunHistoryLimit: successfulRunHistoryLimit } },
    '#withSuspend':: d.fn(help='"Suspend is a flag telling the controller to suspend subsequent runs of the application if set to true.\\nDefaults to false."', args=[d.arg(name='suspend', type=d.T.boolean)]),
    withSuspend(suspend): { spec+: { suspend: suspend } },
    '#withTimeZone':: d.fn(help='"TimeZone is the time zone in which the cron schedule will be interpreted in.\\nThis value is passed to time.LoadLocation, so it must be either \\"Local\\", \\"UTC\\",\\nor a valid IANA location name e.g. \\"America/New_York\\".\\nDefaults to \\"Local\\"."', args=[d.arg(name='timeZone', type=d.T.string)]),
