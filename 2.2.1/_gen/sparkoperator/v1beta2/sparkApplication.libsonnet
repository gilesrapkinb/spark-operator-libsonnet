{
  ...
  '#':: d.pkg(name='sparkApplication', url='', help='"SparkApplication is the Schema for the sparkapplications API"'),
  ...
  '#new':: d.fn(help='new returns an instance of SparkApplication', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'sparkoperator.k8s.io/v1beta2',
    kind: 'SparkApplication',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SparkApplicationSpec defines the desired state of SparkApplication\\nIt carries every pieces of information a spark-submit command takes and recognizes."'),
  spec: {
    ...
    batchSchedulerOptions: {
      ...
      withPriorityClassName(priorityClassName): { spec+: { batchSchedulerOptions+: { priorityClassName: priorityClassName } } },
      ...
      withQueue(queue): { spec+: { batchSchedulerOptions+: { queue: queue } } },
      ...
      withResources(resources): { spec+: { batchSchedulerOptions+: { resources: resources } } },
      ...
      withResourcesMixin(resources): { spec+: { batchSchedulerOptions+: { resources+: resources } } },
    },
    ...
    deps: {
      ...
      withArchives(archives): { spec+: { deps+: { archives: if std.isArray(v=archives) then archives else [archives] } } },
      ...
      withArchivesMixin(archives): { spec+: { deps+: { archives+: if std.isArray(v=archives) then archives else [archives] } } },
      ...
      withExcludePackages(excludePackages): { spec+: { deps+: { excludePackages: if std.isArray(v=excludePackages) then excludePackages else [excludePackages] } } },
      ...
      withExcludePackagesMixin(excludePackages): { spec+: { deps+: { excludePackages+: if std.isArray(v=excludePackages) then excludePackages else [excludePackages] } } },
      '#withFiles':: d.fn(help='"Files is a list of files the Spark application depends on."', args=[d.arg(name='files', type=d.T.array)]),
      withFiles(files): { spec+: { deps+: { files: if std.isArray(v=files) then files else [files] } } },
      ...
      withFilesMixin(files): { spec+: { deps+: { files+: if std.isArray(v=files) then files else [files] } } },
      '#withJars':: d.fn(help='"Jars is a list of JAR files the Spark application depends on."', args=[d.arg(name='jars', type=d.T.array)]),
      withJars(jars): { spec+: { deps+: { jars: if std.isArray(v=jars) then jars else [jars] } } },
      ...
      withJarsMixin(jars): { spec+: { deps+: { jars+: if std.isArray(v=jars) then jars else [jars] } } },
      ...
      withPackages(packages): { spec+: { deps+: { packages: if std.isArray(v=packages) then packages else [packages] } } },
      ...
      withPackagesMixin(packages): { spec+: { deps+: { packages+: if std.isArray(v=packages) then packages else [packages] } } },
      ...
      withPyFiles(pyFiles): { spec+: { deps+: { pyFiles: if std.isArray(v=pyFiles) then pyFiles else [pyFiles] } } },
      ...
      withPyFilesMixin(pyFiles): { spec+: { deps+: { pyFiles+: if std.isArray(v=pyFiles) then pyFiles else [pyFiles] } } },
      ...
      withRepositories(repositories): { spec+: { deps+: { repositories: if std.isArray(v=repositories) then repositories else [repositories] } } },
      ...
      withRepositoriesMixin(repositories): { spec+: { deps+: { repositories+: if std.isArray(v=repositories) then repositories else [repositories] } } },
    },
    ...
    driver: {
      ...
      affinity: {
        ...
        nodeAffinity: {
          ...
          requiredDuringSchedulingIgnoredDuringExecution: {
            ...
            withNodeSelectorTerms(nodeSelectorTerms): { spec+: { driver+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } },
            ...
            withNodeSelectorTermsMixin(nodeSelectorTerms): { spec+: { driver+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms+: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } },
          },
          ...
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { driver+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
        ...
        podAffinity: {
          ...
          withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { driver+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
      ...
      dnsConfig: {
        ...
        withNameservers(nameservers): { spec+: { driver+: { dnsConfig+: { nameservers: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } },
        ...
        withNameserversMixin(nameservers): { spec+: { driver+: { dnsConfig+: { nameservers+: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } },
        ...
        withOptions(options): { spec+: { driver+: { dnsConfig+: { options: if std.isArray(v=options) then options else [options] } } } },
        ...
        withOptionsMixin(options): { spec+: { driver+: { dnsConfig+: { options+: if std.isArray(v=options) then options else [options] } } } },
        ...
        withSearches(searches): { spec+: { driver+: { dnsConfig+: { searches: if std.isArray(v=searches) then searches else [searches] } } } },
        ...
        withSearchesMixin(searches): { spec+: { driver+: { dnsConfig+: { searches+: if std.isArray(v=searches) then searches else [searches] } } } },
      },
      ...
      gpu: {
        ...
        withName(name): { spec+: { driver+: { gpu+: { name: name } } } },
        ...
        withQuantity(quantity): { spec+: { driver+: { gpu+: { quantity: quantity } } } },
      },
      ...
      lifecycle: {
        ...
        postStart: {
          ...
          exec: {
            '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
            withCommand(command): { spec+: { driver+: { lifecycle+: { postStart+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { spec+: { driver+: { lifecycle+: { postStart+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
          },
          '#httpGet':: d.obj(help='"HTTPGet specifies an HTTP GET request to perform."'),
          httpGet: {
            '#httpHeaders':: d.obj(help='"Custom headers to set in the request. HTTP allows repeated headers."'),
            ...
            '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set\\n\\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { spec+: { driver+: { lifecycle+: { postStart+: { httpGet+: { host: host } } } } } },
            '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeaders(httpHeaders): { spec+: { driver+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeadersMixin(httpHeaders): { spec+: { driver+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
            withPath(path): { spec+: { driver+: { lifecycle+: { postStart+: { httpGet+: { path: path } } } } } },
            '#withPort':: d.fn(help='"Name or number of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
            withPort(port): { spec+: { driver+: { lifecycle+: { postStart+: { httpGet+: { port: port } } } } } },
            '#withScheme':: d.fn(help='"Scheme to use for connecting to the host.\\nDefaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
            withScheme(scheme): { spec+: { driver+: { lifecycle+: { postStart+: { httpGet+: { scheme: scheme } } } } } },
          },
          '#sleep':: d.obj(help='"Sleep represents a duration that the container should sleep."'),
          sleep: {
            '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
            withSeconds(seconds): { spec+: { driver+: { lifecycle+: { postStart+: { sleep+: { seconds: seconds } } } } } },
          },
          '#tcpSocket':: d.obj(help='"Deprecated. TCPSocket is NOT supported as a LifecycleHandler and kept\\nfor backward compatibility. There is no validation of this field and\\nlifecycle hooks will fail at runtime when it is specified."'),
          tcpSocket: {
            '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { spec+: { driver+: { lifecycle+: { postStart+: { tcpSocket+: { host: host } } } } } },
            '#withPort':: d.fn(help='"Number or name of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
            withPort(port): { spec+: { driver+: { lifecycle+: { postStart+: { tcpSocket+: { port: port } } } } } },
          },
        },
        '#preStop':: d.obj(help="\"PreStop is called immediately before a container is terminated due to an\\nAPI request or management event such as liveness/startup probe failure,\\npreemption, resource contention, etc. The handler is not called if the\\ncontainer crashes or exits. The Pod's termination grace period countdown begins before the\\nPreStop hook is executed. Regardless of the outcome of the handler, the\\ncontainer will eventually terminate within the Pod's termination grace\\nperiod (unless delayed by finalizers). Other management of the container blocks until the hook completes\\nor until the termination grace period is reached.\\nMore info: https://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/#container-hooks\""),
        preStop: {
          ...
          exec: {
            '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
            withCommand(command): { spec+: { driver+: { lifecycle+: { preStop+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { spec+: { driver+: { lifecycle+: { preStop+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
          },
          '#httpGet':: d.obj(help='"HTTPGet specifies an HTTP GET request to perform."'),
          httpGet: {
            '#httpHeaders':: d.obj(help='"Custom headers to set in the request. HTTP allows repeated headers."'),
            ...
            '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set\\n\\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { spec+: { driver+: { lifecycle+: { preStop+: { httpGet+: { host: host } } } } } },
            '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeaders(httpHeaders): { spec+: { driver+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeadersMixin(httpHeaders): { spec+: { driver+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
            withPath(path): { spec+: { driver+: { lifecycle+: { preStop+: { httpGet+: { path: path } } } } } },
            '#withPort':: d.fn(help='"Name or number of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
            withPort(port): { spec+: { driver+: { lifecycle+: { preStop+: { httpGet+: { port: port } } } } } },
            '#withScheme':: d.fn(help='"Scheme to use for connecting to the host.\\nDefaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
            withScheme(scheme): { spec+: { driver+: { lifecycle+: { preStop+: { httpGet+: { scheme: scheme } } } } } },
          },
          '#sleep':: d.obj(help='"Sleep represents a duration that the container should sleep."'),
          sleep: {
            '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
            withSeconds(seconds): { spec+: { driver+: { lifecycle+: { preStop+: { sleep+: { seconds: seconds } } } } } },
          },
          '#tcpSocket':: d.obj(help='"Deprecated. TCPSocket is NOT supported as a LifecycleHandler and kept\\nfor backward compatibility. There is no validation of this field and\\nlifecycle hooks will fail at runtime when it is specified."'),
          tcpSocket: {
            '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { spec+: { driver+: { lifecycle+: { preStop+: { tcpSocket+: { host: host } } } } } },
            '#withPort':: d.fn(help='"Number or name of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
            withPort(port): { spec+: { driver+: { lifecycle+: { preStop+: { tcpSocket+: { port: port } } } } } },
          },
        },
      },
      ...
      podSecurityContext: {
        ...
        appArmorProfile: {
          '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used.\\nThe profile must be preconfigured on the node to work.\\nMust match the loaded name of the profile.\\nMust be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
          withLocalhostProfile(localhostProfile): { spec+: { driver+: { podSecurityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } },
          '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied.\\nValid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { driver+: { podSecurityContext+: { appArmorProfile+: { type: type } } } } },
        },
        '#seLinuxOptions':: d.obj(help='"The SELinux context to be applied to all containers.\\nIf unspecified, the container runtime will allocate a random SELinux context for each\\ncontainer.  May also be set in SecurityContext.  If set in\\nboth SecurityContext and PodSecurityContext, the value specified in SecurityContext\\ntakes precedence for that container.\\nNote that this field cannot be set when spec.os.name is windows."'),
        seLinuxOptions: {
          '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
          withLevel(level): { spec+: { driver+: { podSecurityContext+: { seLinuxOptions+: { level: level } } } } },
          '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
          withRole(role): { spec+: { driver+: { podSecurityContext+: { seLinuxOptions+: { role: role } } } } },
          '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { driver+: { podSecurityContext+: { seLinuxOptions+: { type: type } } } } },
          '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
          withUser(user): { spec+: { driver+: { podSecurityContext+: { seLinuxOptions+: { user: user } } } } },
        },
        '#seccompProfile':: d.obj(help='"The seccomp options to use by the containers in this pod.\\nNote that this field cannot be set when spec.os.name is windows."'),
        seccompProfile: {
          '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used.\\nThe profile must be preconfigured on the node to work.\\nMust be a descending path, relative to the kubelet's configured seccomp profile location.\\nMust be set if type is \\\"Localhost\\\". Must NOT be set for any other type.\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
          withLocalhostProfile(localhostProfile): { spec+: { driver+: { podSecurityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } } },
          '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied.\\nValid options are:\\n\\nLocalhost - a profile defined in a file on the node should be used.\\nRuntimeDefault - the container runtime default profile should be used.\\nUnconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { driver+: { podSecurityContext+: { seccompProfile+: { type: type } } } } },
        },
        ...
        windowsOptions: {
          '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook\\n(https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the\\nGMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
          withGmsaCredentialSpec(gmsaCredentialSpec): { spec+: { driver+: { podSecurityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } },
          '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
          withGmsaCredentialSpecName(gmsaCredentialSpecName): { spec+: { driver+: { podSecurityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } },
          '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container.\\nAll of a Pod's containers must have the same effective HostProcess value\\n(it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).\\nIn addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
          withHostProcess(hostProcess): { spec+: { driver+: { podSecurityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } },
          '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process.\\nDefaults to the user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext. If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
          withRunAsUserName(runAsUserName): { spec+: { driver+: { podSecurityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } },
        },
        ...
        withFsGroup(fsGroup): { spec+: { driver+: { podSecurityContext+: { fsGroup: fsGroup } } } },
        ...
        withFsGroupChangePolicy(fsGroupChangePolicy): { spec+: { driver+: { podSecurityContext+: { fsGroupChangePolicy: fsGroupChangePolicy } } } },
        '#withRunAsGroup':: d.fn(help='"The GID to run the entrypoint of the container process.\\nUses runtime default if unset.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence\\nfor that container.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
        withRunAsGroup(runAsGroup): { spec+: { driver+: { podSecurityContext+: { runAsGroup: runAsGroup } } } },
        '#withRunAsNonRoot':: d.fn(help='"Indicates that the container must run as a non-root user.\\nIf true, the Kubelet will validate the image at runtime to ensure that it\\ndoes not run as UID 0 (root) and fail to start the container if it does.\\nIf unset or false, no such validation will be performed.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
        withRunAsNonRoot(runAsNonRoot): { spec+: { driver+: { podSecurityContext+: { runAsNonRoot: runAsNonRoot } } } },
        '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process.\\nDefaults to user specified in image metadata if unspecified.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence\\nfor that container.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
        withRunAsUser(runAsUser): { spec+: { driver+: { podSecurityContext+: { runAsUser: runAsUser } } } },
        ...
        withSeLinuxChangePolicy(seLinuxChangePolicy): { spec+: { driver+: { podSecurityContext+: { seLinuxChangePolicy: seLinuxChangePolicy } } } },
        ...
        withSupplementalGroups(supplementalGroups): { spec+: { driver+: { podSecurityContext+: { supplementalGroups: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } },
        ...
        withSupplementalGroupsMixin(supplementalGroups): { spec+: { driver+: { podSecurityContext+: { supplementalGroups+: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } },
        ...
        withSupplementalGroupsPolicy(supplementalGroupsPolicy): { spec+: { driver+: { podSecurityContext+: { supplementalGroupsPolicy: supplementalGroupsPolicy } } } },
        ...
        withSysctls(sysctls): { spec+: { driver+: { podSecurityContext+: { sysctls: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } },
        ...
        withSysctlsMixin(sysctls): { spec+: { driver+: { podSecurityContext+: { sysctls+: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } },
      },
      ...
      securityContext: {
        ...
        appArmorProfile: {
          '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used.\\nThe profile must be preconfigured on the node to work.\\nMust match the loaded name of the profile.\\nMust be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
          withLocalhostProfile(localhostProfile): { spec+: { driver+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } },
          '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied.\\nValid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { driver+: { securityContext+: { appArmorProfile+: { type: type } } } } },
        },
        '#capabilities':: d.obj(help='"The capabilities to add/drop when running containers.\\nDefaults to the default set of capabilities granted by the container runtime.\\nNote that this field cannot be set when spec.os.name is windows."'),
        capabilities: {
          '#withAdd':: d.fn(help='"Added capabilities"', args=[d.arg(name='add', type=d.T.array)]),
          withAdd(add): { spec+: { driver+: { securityContext+: { capabilities+: { add: if std.isArray(v=add) then add else [add] } } } } },
          '#withAddMixin':: d.fn(help='"Added capabilities"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='add', type=d.T.array)]),
          withAddMixin(add): { spec+: { driver+: { securityContext+: { capabilities+: { add+: if std.isArray(v=add) then add else [add] } } } } },
          '#withDrop':: d.fn(help='"Removed capabilities"', args=[d.arg(name='drop', type=d.T.array)]),
          withDrop(drop): { spec+: { driver+: { securityContext+: { capabilities+: { drop: if std.isArray(v=drop) then drop else [drop] } } } } },
          '#withDropMixin':: d.fn(help='"Removed capabilities"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='drop', type=d.T.array)]),
          withDropMixin(drop): { spec+: { driver+: { securityContext+: { capabilities+: { drop+: if std.isArray(v=drop) then drop else [drop] } } } } },
        },
        '#seLinuxOptions':: d.obj(help='"The SELinux context to be applied to the container.\\nIf unspecified, the container runtime will allocate a random SELinux context for each\\ncontainer.  May also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."'),
        seLinuxOptions: {
          '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
          withLevel(level): { spec+: { driver+: { securityContext+: { seLinuxOptions+: { level: level } } } } },
          '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
          withRole(role): { spec+: { driver+: { securityContext+: { seLinuxOptions+: { role: role } } } } },
          '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { driver+: { securityContext+: { seLinuxOptions+: { type: type } } } } },
          '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
          withUser(user): { spec+: { driver+: { securityContext+: { seLinuxOptions+: { user: user } } } } },
        },
        '#seccompProfile':: d.obj(help='"The seccomp options to use by this container. If seccomp options are\\nprovided at both the pod & container level, the container options\\noverride the pod options.\\nNote that this field cannot be set when spec.os.name is windows."'),
        seccompProfile: {
          '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used.\\nThe profile must be preconfigured on the node to work.\\nMust be a descending path, relative to the kubelet's configured seccomp profile location.\\nMust be set if type is \\\"Localhost\\\". Must NOT be set for any other type.\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
          withLocalhostProfile(localhostProfile): { spec+: { driver+: { securityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } } },
          '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied.\\nValid options are:\\n\\nLocalhost - a profile defined in a file on the node should be used.\\nRuntimeDefault - the container runtime default profile should be used.\\nUnconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { driver+: { securityContext+: { seccompProfile+: { type: type } } } } },
        },
        '#windowsOptions':: d.obj(help='"The Windows specific settings applied to all containers.\\nIf unspecified, the options from the PodSecurityContext will be used.\\nIf set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is linux."'),
        windowsOptions: {
          '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook\\n(https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the\\nGMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
          withGmsaCredentialSpec(gmsaCredentialSpec): { spec+: { driver+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } },
          '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
          withGmsaCredentialSpecName(gmsaCredentialSpecName): { spec+: { driver+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } },
          '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container.\\nAll of a Pod's containers must have the same effective HostProcess value\\n(it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).\\nIn addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
          withHostProcess(hostProcess): { spec+: { driver+: { securityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } },
          '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process.\\nDefaults to the user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext. If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
          withRunAsUserName(runAsUserName): { spec+: { driver+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } },
        },
        '#withAllowPrivilegeEscalation':: d.fn(help='"AllowPrivilegeEscalation controls whether a process can gain more\\nprivileges than its parent process. This bool directly controls if\\nthe no_new_privs flag will be set on the container process.\\nAllowPrivilegeEscalation is true always when the container is:\\n1) run as Privileged\\n2) has CAP_SYS_ADMIN\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='allowPrivilegeEscalation', type=d.T.boolean)]),
        withAllowPrivilegeEscalation(allowPrivilegeEscalation): { spec+: { driver+: { securityContext+: { allowPrivilegeEscalation: allowPrivilegeEscalation } } } },
        '#withPrivileged':: d.fn(help='"Run container in privileged mode.\\nProcesses in privileged containers are essentially equivalent to root on the host.\\nDefaults to false.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='privileged', type=d.T.boolean)]),
        withPrivileged(privileged): { spec+: { driver+: { securityContext+: { privileged: privileged } } } },
        '#withProcMount':: d.fn(help='"procMount denotes the type of proc mount to use for the containers.\\nThe default value is Default which uses the container runtime defaults for\\nreadonly paths and masked paths.\\nThis requires the ProcMountType feature flag to be enabled.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='procMount', type=d.T.string)]),
        withProcMount(procMount): { spec+: { driver+: { securityContext+: { procMount: procMount } } } },
        '#withReadOnlyRootFilesystem':: d.fn(help='"Whether this container has a read-only root filesystem.\\nDefault is false.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='readOnlyRootFilesystem', type=d.T.boolean)]),
        withReadOnlyRootFilesystem(readOnlyRootFilesystem): { spec+: { driver+: { securityContext+: { readOnlyRootFilesystem: readOnlyRootFilesystem } } } },
        '#withRunAsGroup':: d.fn(help='"The GID to run the entrypoint of the container process.\\nUses runtime default if unset.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
        withRunAsGroup(runAsGroup): { spec+: { driver+: { securityContext+: { runAsGroup: runAsGroup } } } },
        '#withRunAsNonRoot':: d.fn(help='"Indicates that the container must run as a non-root user.\\nIf true, the Kubelet will validate the image at runtime to ensure that it\\ndoes not run as UID 0 (root) and fail to start the container if it does.\\nIf unset or false, no such validation will be performed.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
        withRunAsNonRoot(runAsNonRoot): { spec+: { driver+: { securityContext+: { runAsNonRoot: runAsNonRoot } } } },
        '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process.\\nDefaults to user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
        withRunAsUser(runAsUser): { spec+: { driver+: { securityContext+: { runAsUser: runAsUser } } } },
      },
      ...
      withAnnotations(annotations): { spec+: { driver+: { annotations: annotations } } },
      '#withAnnotationsMixin':: d.fn(help='"Annotations are the Kubernetes annotations to be added to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotationsMixin(annotations): { spec+: { driver+: { annotations+: annotations } } },
      ...
      withConfigMaps(configMaps): { spec+: { driver+: { configMaps: if std.isArray(v=configMaps) then configMaps else [configMaps] } } },
      ...
      withConfigMapsMixin(configMaps): { spec+: { driver+: { configMaps+: if std.isArray(v=configMaps) then configMaps else [configMaps] } } },
      ...
      withCoreLimit(coreLimit): { spec+: { driver+: { coreLimit: coreLimit } } },
      ...
      withCoreRequest(coreRequest): { spec+: { driver+: { coreRequest: coreRequest } } },
      ...
      withEnvFrom(envFrom): { spec+: { driver+: { envFrom: if std.isArray(v=envFrom) then envFrom else [envFrom] } } },
      '#withEnvFromMixin':: d.fn(help='"EnvFrom is a list of sources to populate environment variables in the container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envFrom', type=d.T.array)]),
      withEnvFromMixin(envFrom): { spec+: { driver+: { envFrom+: if std.isArray(v=envFrom) then envFrom else [envFrom] } } },
      '#withEnvMixin':: d.fn(help='"Env carries the environment variables to add to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='env', type=d.T.array)]),
      withEnvMixin(env): { spec+: { driver+: { env+: if std.isArray(v=env) then env else [env] } } },
      ...
      withEnvSecretKeyRefs(envSecretKeyRefs): { spec+: { driver+: { envSecretKeyRefs: envSecretKeyRefs } } },
      ...
      withEnvSecretKeyRefsMixin(envSecretKeyRefs): { spec+: { driver+: { envSecretKeyRefs+: envSecretKeyRefs } } },
      ...
      withEnvVars(envVars): { spec+: { driver+: { envVars: envVars } } },
      ...
      withEnvVarsMixin(envVars): { spec+: { driver+: { envVars+: envVars } } },
      ...
      withHostAliases(hostAliases): { spec+: { driver+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } },
      ...
      withHostAliasesMixin(hostAliases): { spec+: { driver+: { hostAliases+: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } },
      ...
      withHostNetwork(hostNetwork): { spec+: { driver+: { hostNetwork: hostNetwork } } },
      ...
      withImage(image): { spec+: { driver+: { image: image } } },
      ...
      withInitContainers(initContainers): { spec+: { driver+: { initContainers: if std.isArray(v=initContainers) then initContainers else [initContainers] } } },
      ...
      withInitContainersMixin(initContainers): { spec+: { driver+: { initContainers+: if std.isArray(v=initContainers) then initContainers else [initContainers] } } },
      ...
      withJavaOptions(javaOptions): { spec+: { driver+: { javaOptions: javaOptions } } },
      ...
      withMemoryOverhead(memoryOverhead): { spec+: { driver+: { memoryOverhead: memoryOverhead } } },
      ...
      withNodeSelector(nodeSelector): { spec+: { driver+: { nodeSelector: nodeSelector } } },
      ...
      withNodeSelectorMixin(nodeSelector): { spec+: { driver+: { nodeSelector+: nodeSelector } } },
      ...
      withPodName(podName): { spec+: { driver+: { podName: podName } } },
      ...
      withPorts(ports): { spec+: { driver+: { ports: if std.isArray(v=ports) then ports else [ports] } } },
      '#withPortsMixin':: d.fn(help='"Ports settings for the pods, following the Kubernetes specifications."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ports', type=d.T.array)]),
      withPortsMixin(ports): { spec+: { driver+: { ports+: if std.isArray(v=ports) then ports else [ports] } } },
      ...
      withPriorityClassName(priorityClassName): { spec+: { driver+: { priorityClassName: priorityClassName } } },
      ...
      withSchedulerName(schedulerName): { spec+: { driver+: { schedulerName: schedulerName } } },
      '#withSecrets':: d.fn(help='"Secrets carries information of secrets to add to the pod."', args=[d.arg(name='secrets', type=d.T.array)]),
      withSecrets(secrets): { spec+: { driver+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } } },
      ...
      withSecretsMixin(secrets): { spec+: { driver+: { secrets+: if std.isArray(v=secrets) then secrets else [secrets] } } },
      ...
      withServiceAccount(serviceAccount): { spec+: { driver+: { serviceAccount: serviceAccount } } },
      ...
      withServiceAnnotations(serviceAnnotations): { spec+: { driver+: { serviceAnnotations: serviceAnnotations } } },
      ...
      withServiceAnnotationsMixin(serviceAnnotations): { spec+: { driver+: { serviceAnnotations+: serviceAnnotations } } },
      ...
      withServiceLabels(serviceLabels): { spec+: { driver+: { serviceLabels: serviceLabels } } },
      ...
      withServiceLabelsMixin(serviceLabels): { spec+: { driver+: { serviceLabels+: serviceLabels } } },
      ...
      withShareProcessNamespace(shareProcessNamespace): { spec+: { driver+: { shareProcessNamespace: shareProcessNamespace } } },
      ...
      withSidecars(sidecars): { spec+: { driver+: { sidecars: if std.isArray(v=sidecars) then sidecars else [sidecars] } } },
      ...
      withSidecarsMixin(sidecars): { spec+: { driver+: { sidecars+: if std.isArray(v=sidecars) then sidecars else [sidecars] } } },
      ...
      withTemplate(template): { spec+: { driver+: { template: template } } },
      ...
      withTemplateMixin(template): { spec+: { driver+: { template+: template } } },
      ...
      withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { spec+: { driver+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } },
      ...
      withTolerations(tolerations): { spec+: { driver+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } } },
      ...
      withTolerationsMixin(tolerations): { spec+: { driver+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } } },
      ...
      withVolumeMounts(volumeMounts): { spec+: { driver+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
      ...
      withVolumeMountsMixin(volumeMounts): { spec+: { driver+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
    },
    ...
    dynamicAllocation: {
      ...
      withEnabled(enabled): { spec+: { dynamicAllocation+: { enabled: enabled } } },
      ...
      withInitialExecutors(initialExecutors): { spec+: { dynamicAllocation+: { initialExecutors: initialExecutors } } },
      ...
      withMaxExecutors(maxExecutors): { spec+: { dynamicAllocation+: { maxExecutors: maxExecutors } } },
      ...
      withMinExecutors(minExecutors): { spec+: { dynamicAllocation+: { minExecutors: minExecutors } } },
      ...
      withShuffleTrackingEnabled(shuffleTrackingEnabled): { spec+: { dynamicAllocation+: { shuffleTrackingEnabled: shuffleTrackingEnabled } } },
      ...
      withShuffleTrackingTimeout(shuffleTrackingTimeout): { spec+: { dynamicAllocation+: { shuffleTrackingTimeout: shuffleTrackingTimeout } } },
    },
    ...
    executor: {
      ...
      affinity: {
        ...
        nodeAffinity: {
          ...
          requiredDuringSchedulingIgnoredDuringExecution: {
            ...
            '#withNodeSelectorTerms':: d.fn(help='"Required. A list of node selector terms. The terms are ORed."', args=[d.arg(name='nodeSelectorTerms', type=d.T.array)]),
            withNodeSelectorTerms(nodeSelectorTerms): { spec+: { executor+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } },
            '#withNodeSelectorTermsMixin':: d.fn(help='"Required. A list of node selector terms. The terms are ORed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeSelectorTerms', type=d.T.array)]),
            withNodeSelectorTermsMixin(nodeSelectorTerms): { spec+: { executor+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms+: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } },
          },
          '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node matches the corresponding matchExpressions; the\\nnode(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { executor+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node matches the corresponding matchExpressions; the\\nnode(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { executor+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
        '#podAffinity':: d.obj(help='"Describes pod affinity scheduling rules (e.g. co-locate this pod in the same node, zone, etc. as some other pod(s))."'),
        podAffinity: {
          '#preferredDuringSchedulingIgnoredDuringExecution':: d.obj(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."'),
          ...
          '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { executor+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { executor+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withRequiredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"If the affinity requirements specified by this field are not met at\\nscheduling time, the pod will not be scheduled onto the node.\\nIf the affinity requirements specified by this field cease to be met\\nat some point during pod execution (e.g. due to a pod label update), the\\nsystem may or may not try to eventually evict the pod from its node.\\nWhen there are multiple elements, the lists of nodes corresponding to each\\npodAffinityTerm are intersected, i.e. all terms must be satisfied."', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { executor+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withRequiredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"If the affinity requirements specified by this field are not met at\\nscheduling time, the pod will not be scheduled onto the node.\\nIf the affinity requirements specified by this field cease to be met\\nat some point during pod execution (e.g. due to a pod label update), the\\nsystem may or may not try to eventually evict the pod from its node.\\nWhen there are multiple elements, the lists of nodes corresponding to each\\npodAffinityTerm are intersected, i.e. all terms must be satisfied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { executor+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
        '#podAntiAffinity':: d.obj(help='"Describes pod anti-affinity scheduling rules (e.g. avoid putting this pod in the same node, zone, etc. as some other pod(s))."'),
        podAntiAffinity: {
          '#preferredDuringSchedulingIgnoredDuringExecution':: d.obj(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe anti-affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling anti-affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."'),
          ...
          '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe anti-affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling anti-affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { executor+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"The scheduler will prefer to schedule pods to nodes that satisfy\\nthe anti-affinity expressions specified by this field, but it may choose\\na node that violates one or more of the expressions. The node that is\\nmost preferred is the one with the greatest sum of weights, i.e.\\nfor each node that meets all of the scheduling requirements (resource\\nrequest, requiredDuringScheduling anti-affinity expressions, etc.),\\ncompute a sum by iterating through the elements of this field and adding\\n\\"weight\\" to the sum if the node has pods which matches the corresponding podAffinityTerm; the\\nnode(s) with the highest sum are the most preferred."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { spec+: { executor+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withRequiredDuringSchedulingIgnoredDuringExecution':: d.fn(help='"If the anti-affinity requirements specified by this field are not met at\\nscheduling time, the pod will not be scheduled onto the node.\\nIf the anti-affinity requirements specified by this field cease to be met\\nat some point during pod execution (e.g. due to a pod label update), the\\nsystem may or may not try to eventually evict the pod from its node.\\nWhen there are multiple elements, the lists of nodes corresponding to each\\npodAffinityTerm are intersected, i.e. all terms must be satisfied."', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { executor+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withRequiredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='"If the anti-affinity requirements specified by this field are not met at\\nscheduling time, the pod will not be scheduled onto the node.\\nIf the anti-affinity requirements specified by this field cease to be met\\nat some point during pod execution (e.g. due to a pod label update), the\\nsystem may or may not try to eventually evict the pod from its node.\\nWhen there are multiple elements, the lists of nodes corresponding to each\\npodAffinityTerm are intersected, i.e. all terms must be satisfied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { spec+: { executor+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
      },
      '#configMaps':: d.obj(help='"ConfigMaps carries information of other ConfigMaps to add to the pod."'),
      configMaps: {
      ...
      dnsConfig: {
        ...
        '#withNameservers':: d.fn(help='"A list of DNS name server IP addresses.\\nThis will be appended to the base nameservers generated from DNSPolicy.\\nDuplicated nameservers will be removed."', args=[d.arg(name='nameservers', type=d.T.array)]),
        withNameservers(nameservers): { spec+: { executor+: { dnsConfig+: { nameservers: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } },
        '#withNameserversMixin':: d.fn(help='"A list of DNS name server IP addresses.\\nThis will be appended to the base nameservers generated from DNSPolicy.\\nDuplicated nameservers will be removed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nameservers', type=d.T.array)]),
        withNameserversMixin(nameservers): { spec+: { executor+: { dnsConfig+: { nameservers+: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } },
        '#withOptions':: d.fn(help='"A list of DNS resolver options.\\nThis will be merged with the base options generated from DNSPolicy.\\nDuplicated entries will be removed. Resolution options given in Options\\nwill override those that appear in the base DNSPolicy."', args=[d.arg(name='options', type=d.T.array)]),
        withOptions(options): { spec+: { executor+: { dnsConfig+: { options: if std.isArray(v=options) then options else [options] } } } },
        '#withOptionsMixin':: d.fn(help='"A list of DNS resolver options.\\nThis will be merged with the base options generated from DNSPolicy.\\nDuplicated entries will be removed. Resolution options given in Options\\nwill override those that appear in the base DNSPolicy."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='options', type=d.T.array)]),
        withOptionsMixin(options): { spec+: { executor+: { dnsConfig+: { options+: if std.isArray(v=options) then options else [options] } } } },
        '#withSearches':: d.fn(help='"A list of DNS search domains for host-name lookup.\\nThis will be appended to the base search paths generated from DNSPolicy.\\nDuplicated search paths will be removed."', args=[d.arg(name='searches', type=d.T.array)]),
        withSearches(searches): { spec+: { executor+: { dnsConfig+: { searches: if std.isArray(v=searches) then searches else [searches] } } } },
        '#withSearchesMixin':: d.fn(help='"A list of DNS search domains for host-name lookup.\\nThis will be appended to the base search paths generated from DNSPolicy.\\nDuplicated search paths will be removed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='searches', type=d.T.array)]),
        withSearchesMixin(searches): { spec+: { executor+: { dnsConfig+: { searches+: if std.isArray(v=searches) then searches else [searches] } } } },
      },
      '#env':: d.obj(help='"Env carries the environment variables to add to the pod."'),
      env: {
        '#valueFrom':: d.obj(help="\"Source for the environment variable's value. Cannot be used if value is not empty.\""),
      ...
      gpu: {
        '#withName':: d.fn(help='"Name is GPU resource name, such as: nvidia.com/gpu or amd.com/gpu"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { executor+: { gpu+: { name: name } } } },
        '#withQuantity':: d.fn(help='"Quantity is the number of GPUs to request for driver or executor."', args=[d.arg(name='quantity', type=d.T.integer)]),
        withQuantity(quantity): { spec+: { executor+: { gpu+: { quantity: quantity } } } },
      },
      '#hostAliases':: d.obj(help='"HostAliases settings for the pod, following the Kubernetes specifications."'),
      hostAliases: {
        '#withHostnames':: d.fn(help='"Hostnames for the above IP address."', args=[d.arg(name='hostnames', type=d.T.array)]),
      ...
      lifecycle: {
        ...
        postStart: {
          ...
          exec: {
            '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
            withCommand(command): { spec+: { executor+: { lifecycle+: { postStart+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { spec+: { executor+: { lifecycle+: { postStart+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
          },
          '#httpGet':: d.obj(help='"HTTPGet specifies an HTTP GET request to perform."'),
          httpGet: {
            '#httpHeaders':: d.obj(help='"Custom headers to set in the request. HTTP allows repeated headers."'),
            ...
            '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set\\n\\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { spec+: { executor+: { lifecycle+: { postStart+: { httpGet+: { host: host } } } } } },
            '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeaders(httpHeaders): { spec+: { executor+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeadersMixin(httpHeaders): { spec+: { executor+: { lifecycle+: { postStart+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
            withPath(path): { spec+: { executor+: { lifecycle+: { postStart+: { httpGet+: { path: path } } } } } },
            '#withPort':: d.fn(help='"Name or number of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
            withPort(port): { spec+: { executor+: { lifecycle+: { postStart+: { httpGet+: { port: port } } } } } },
            '#withScheme':: d.fn(help='"Scheme to use for connecting to the host.\\nDefaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
            withScheme(scheme): { spec+: { executor+: { lifecycle+: { postStart+: { httpGet+: { scheme: scheme } } } } } },
          },
          '#sleep':: d.obj(help='"Sleep represents a duration that the container should sleep."'),
          sleep: {
            '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
            withSeconds(seconds): { spec+: { executor+: { lifecycle+: { postStart+: { sleep+: { seconds: seconds } } } } } },
          },
          '#tcpSocket':: d.obj(help='"Deprecated. TCPSocket is NOT supported as a LifecycleHandler and kept\\nfor backward compatibility. There is no validation of this field and\\nlifecycle hooks will fail at runtime when it is specified."'),
          tcpSocket: {
            '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { spec+: { executor+: { lifecycle+: { postStart+: { tcpSocket+: { host: host } } } } } },
            '#withPort':: d.fn(help='"Number or name of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
            withPort(port): { spec+: { executor+: { lifecycle+: { postStart+: { tcpSocket+: { port: port } } } } } },
          },
        },
        '#preStop':: d.obj(help="\"PreStop is called immediately before a container is terminated due to an\\nAPI request or management event such as liveness/startup probe failure,\\npreemption, resource contention, etc. The handler is not called if the\\ncontainer crashes or exits. The Pod's termination grace period countdown begins before the\\nPreStop hook is executed. Regardless of the outcome of the handler, the\\ncontainer will eventually terminate within the Pod's termination grace\\nperiod (unless delayed by finalizers). Other management of the container blocks until the hook completes\\nor until the termination grace period is reached.\\nMore info: https://kubernetes.io/docs/concepts/containers/container-lifecycle-hooks/#container-hooks\""),
        preStop: {
          ...
          exec: {
            '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
            withCommand(command): { spec+: { executor+: { lifecycle+: { preStop+: { exec+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the\\ncommand  is root ('/') in the container's filesystem. The command is simply exec'd, it is\\nnot run inside a shell, so traditional shell instructions ('|', etc) won't work. To use\\na shell, you need to explicitly call out to that shell.\\nExit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { spec+: { executor+: { lifecycle+: { preStop+: { exec+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
          },
          '#httpGet':: d.obj(help='"HTTPGet specifies an HTTP GET request to perform."'),
          httpGet: {
            '#httpHeaders':: d.obj(help='"Custom headers to set in the request. HTTP allows repeated headers."'),
            ...
            '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set\\n\\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { spec+: { executor+: { lifecycle+: { preStop+: { httpGet+: { host: host } } } } } },
            '#withHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeaders(httpHeaders): { spec+: { executor+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withHttpHeadersMixin':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='httpHeaders', type=d.T.array)]),
            withHttpHeadersMixin(httpHeaders): { spec+: { executor+: { lifecycle+: { preStop+: { httpGet+: { httpHeaders+: if std.isArray(v=httpHeaders) then httpHeaders else [httpHeaders] } } } } } },
            '#withPath':: d.fn(help='"Path to access on the HTTP server."', args=[d.arg(name='path', type=d.T.string)]),
            withPath(path): { spec+: { executor+: { lifecycle+: { preStop+: { httpGet+: { path: path } } } } } },
            '#withPort':: d.fn(help='"Name or number of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
            withPort(port): { spec+: { executor+: { lifecycle+: { preStop+: { httpGet+: { port: port } } } } } },
            '#withScheme':: d.fn(help='"Scheme to use for connecting to the host.\\nDefaults to HTTP."', args=[d.arg(name='scheme', type=d.T.string)]),
            withScheme(scheme): { spec+: { executor+: { lifecycle+: { preStop+: { httpGet+: { scheme: scheme } } } } } },
          },
          '#sleep':: d.obj(help='"Sleep represents a duration that the container should sleep."'),
          sleep: {
            '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
            withSeconds(seconds): { spec+: { executor+: { lifecycle+: { preStop+: { sleep+: { seconds: seconds } } } } } },
          },
          '#tcpSocket':: d.obj(help='"Deprecated. TCPSocket is NOT supported as a LifecycleHandler and kept\\nfor backward compatibility. There is no validation of this field and\\nlifecycle hooks will fail at runtime when it is specified."'),
          tcpSocket: {
            '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { spec+: { executor+: { lifecycle+: { preStop+: { tcpSocket+: { host: host } } } } } },
            '#withPort':: d.fn(help='"Number or name of the port to access on the container.\\nNumber must be in the range 1 to 65535.\\nName must be an IANA_SVC_NAME."', args=[d.arg(name='port', type=d.T.any)]),
            withPort(port): { spec+: { executor+: { lifecycle+: { preStop+: { tcpSocket+: { port: port } } } } } },
          },
        },
      },
      '#podSecurityContext':: d.obj(help='"PodSecurityContext specifies the PodSecurityContext to apply."'),
      podSecurityContext: {
        ...
        appArmorProfile: {
          '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used.\\nThe profile must be preconfigured on the node to work.\\nMust match the loaded name of the profile.\\nMust be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
          withLocalhostProfile(localhostProfile): { spec+: { executor+: { podSecurityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } },
          '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied.\\nValid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { executor+: { podSecurityContext+: { appArmorProfile+: { type: type } } } } },
        },
        '#seLinuxOptions':: d.obj(help='"The SELinux context to be applied to all containers.\\nIf unspecified, the container runtime will allocate a random SELinux context for each\\ncontainer.  May also be set in SecurityContext.  If set in\\nboth SecurityContext and PodSecurityContext, the value specified in SecurityContext\\ntakes precedence for that container.\\nNote that this field cannot be set when spec.os.name is windows."'),
        seLinuxOptions: {
          '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
          withLevel(level): { spec+: { executor+: { podSecurityContext+: { seLinuxOptions+: { level: level } } } } },
          '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
          withRole(role): { spec+: { executor+: { podSecurityContext+: { seLinuxOptions+: { role: role } } } } },
          '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { executor+: { podSecurityContext+: { seLinuxOptions+: { type: type } } } } },
          '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
          withUser(user): { spec+: { executor+: { podSecurityContext+: { seLinuxOptions+: { user: user } } } } },
        },
        '#seccompProfile':: d.obj(help='"The seccomp options to use by the containers in this pod.\\nNote that this field cannot be set when spec.os.name is windows."'),
        seccompProfile: {
          '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used.\\nThe profile must be preconfigured on the node to work.\\nMust be a descending path, relative to the kubelet's configured seccomp profile location.\\nMust be set if type is \\\"Localhost\\\". Must NOT be set for any other type.\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
          withLocalhostProfile(localhostProfile): { spec+: { executor+: { podSecurityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } } },
          '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied.\\nValid options are:\\n\\nLocalhost - a profile defined in a file on the node should be used.\\nRuntimeDefault - the container runtime default profile should be used.\\nUnconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { executor+: { podSecurityContext+: { seccompProfile+: { type: type } } } } },
        },
        '#sysctls':: d.obj(help='"Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported\\nsysctls (by the container runtime) might fail to launch.\\nNote that this field cannot be set when spec.os.name is windows."'),
        sysctls: {
          '#withName':: d.fn(help='"Name of a property to set"', args=[d.arg(name='name', type=d.T.string)]),
        ...
        windowsOptions: {
          '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook\\n(https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the\\nGMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
          withGmsaCredentialSpec(gmsaCredentialSpec): { spec+: { executor+: { podSecurityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } },
          '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
          withGmsaCredentialSpecName(gmsaCredentialSpecName): { spec+: { executor+: { podSecurityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } },
          '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container.\\nAll of a Pod's containers must have the same effective HostProcess value\\n(it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).\\nIn addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
          withHostProcess(hostProcess): { spec+: { executor+: { podSecurityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } },
          '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process.\\nDefaults to the user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext. If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
          withRunAsUserName(runAsUserName): { spec+: { executor+: { podSecurityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } },
        },
        '#withFsGroup':: d.fn(help="\"A special supplemental group that applies to all containers in a pod.\\nSome volume types allow the Kubelet to change the ownership of that volume\\nto be owned by the pod:\\n\\n1. The owning GID will be the FSGroup\\n2. The setgid bit is set (new files created in the volume will be owned by FSGroup)\\n3. The permission bits are OR'd with rw-rw----\\n\\nIf unset, the Kubelet will not modify the ownership and permissions of any volume.\\nNote that this field cannot be set when spec.os.name is windows.\"", args=[d.arg(name='fsGroup', type=d.T.integer)]),
        withFsGroup(fsGroup): { spec+: { executor+: { podSecurityContext+: { fsGroup: fsGroup } } } },
        '#withFsGroupChangePolicy':: d.fn(help='"fsGroupChangePolicy defines behavior of changing ownership and permission of the volume\\nbefore being exposed inside Pod. This field will only apply to\\nvolume types which support fsGroup based ownership(and permissions).\\nIt will have no effect on ephemeral volume types such as: secret, configmaps\\nand emptydir.\\nValid values are \\"OnRootMismatch\\" and \\"Always\\". If not specified, \\"Always\\" is used.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='fsGroupChangePolicy', type=d.T.string)]),
        withFsGroupChangePolicy(fsGroupChangePolicy): { spec+: { executor+: { podSecurityContext+: { fsGroupChangePolicy: fsGroupChangePolicy } } } },
        '#withRunAsGroup':: d.fn(help='"The GID to run the entrypoint of the container process.\\nUses runtime default if unset.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence\\nfor that container.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
        withRunAsGroup(runAsGroup): { spec+: { executor+: { podSecurityContext+: { runAsGroup: runAsGroup } } } },
        '#withRunAsNonRoot':: d.fn(help='"Indicates that the container must run as a non-root user.\\nIf true, the Kubelet will validate the image at runtime to ensure that it\\ndoes not run as UID 0 (root) and fail to start the container if it does.\\nIf unset or false, no such validation will be performed.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
        withRunAsNonRoot(runAsNonRoot): { spec+: { executor+: { podSecurityContext+: { runAsNonRoot: runAsNonRoot } } } },
        '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process.\\nDefaults to user specified in image metadata if unspecified.\\nMay also be set in SecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence\\nfor that container.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
        withRunAsUser(runAsUser): { spec+: { executor+: { podSecurityContext+: { runAsUser: runAsUser } } } },
        '#withSeLinuxChangePolicy':: d.fn(help="\"seLinuxChangePolicy defines how the container's SELinux label is applied to all volumes used by the Pod.\\nIt has no effect on nodes that do not support SELinux or to volumes does not support SELinux.\\nValid values are \\\"MountOption\\\" and \\\"Recursive\\\".\\n\\n\\\"Recursive\\\" means relabeling of all files on all Pod volumes by the container runtime.\\nThis may be slow for large volumes, but allows mixing privileged and unprivileged Pods sharing the same volume on the same node.\\n\\n\\\"MountOption\\\" mounts all eligible Pod volumes with `-o context` mount option.\\nThis requires all Pods that share the same volume to use the same SELinux label.\\nIt is not possible to share the same volume among privileged and unprivileged Pods.\\nEligible volumes are in-tree FibreChannel and iSCSI volumes, and all CSI volumes\\nwhose CSI driver announces SELinux support by setting spec.seLinuxMount: true in their\\nCSIDriver instance. Other volumes are always re-labelled recursively.\\n\\\"MountOption\\\" value is allowed only when SELinuxMount feature gate is enabled.\\n\\nIf not specified and SELinuxMount feature gate is enabled, \\\"MountOption\\\" is used.\\nIf not specified and SELinuxMount feature gate is disabled, \\\"MountOption\\\" is used for ReadWriteOncePod volumes\\nand \\\"Recursive\\\" for all other volumes.\\n\\nThis field affects only Pods that have SELinux label set, either in PodSecurityContext or in SecurityContext of all containers.\\n\\nAll Pods that use the same volume should use the same seLinuxChangePolicy, otherwise some pods can get stuck in ContainerCreating state.\\nNote that this field cannot be set when spec.os.name is windows.\"", args=[d.arg(name='seLinuxChangePolicy', type=d.T.string)]),
        withSeLinuxChangePolicy(seLinuxChangePolicy): { spec+: { executor+: { podSecurityContext+: { seLinuxChangePolicy: seLinuxChangePolicy } } } },
        '#withSupplementalGroups':: d.fn(help="\"A list of groups applied to the first process run in each container, in\\naddition to the container's primary GID and fsGroup (if specified).  If\\nthe SupplementalGroupsPolicy feature is enabled, the\\nsupplementalGroupsPolicy field determines whether these are in addition\\nto or instead of any group memberships defined in the container image.\\nIf unspecified, no additional groups are added, though group memberships\\ndefined in the container image may still be used, depending on the\\nsupplementalGroupsPolicy field.\\nNote that this field cannot be set when spec.os.name is windows.\"", args=[d.arg(name='supplementalGroups', type=d.T.array)]),
        withSupplementalGroups(supplementalGroups): { spec+: { executor+: { podSecurityContext+: { supplementalGroups: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } },
        '#withSupplementalGroupsMixin':: d.fn(help="\"A list of groups applied to the first process run in each container, in\\naddition to the container's primary GID and fsGroup (if specified).  If\\nthe SupplementalGroupsPolicy feature is enabled, the\\nsupplementalGroupsPolicy field determines whether these are in addition\\nto or instead of any group memberships defined in the container image.\\nIf unspecified, no additional groups are added, though group memberships\\ndefined in the container image may still be used, depending on the\\nsupplementalGroupsPolicy field.\\nNote that this field cannot be set when spec.os.name is windows.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='supplementalGroups', type=d.T.array)]),
        withSupplementalGroupsMixin(supplementalGroups): { spec+: { executor+: { podSecurityContext+: { supplementalGroups+: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } },
        '#withSupplementalGroupsPolicy':: d.fn(help='"Defines how supplemental groups of the first container processes are calculated.\\nValid values are \\"Merge\\" and \\"Strict\\". If not specified, \\"Merge\\" is used.\\n(Alpha) Using the field requires the SupplementalGroupsPolicy feature gate to be enabled\\nand the container runtime must implement support for this feature.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='supplementalGroupsPolicy', type=d.T.string)]),
        withSupplementalGroupsPolicy(supplementalGroupsPolicy): { spec+: { executor+: { podSecurityContext+: { supplementalGroupsPolicy: supplementalGroupsPolicy } } } },
        '#withSysctls':: d.fn(help='"Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported\\nsysctls (by the container runtime) might fail to launch.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='sysctls', type=d.T.array)]),
        withSysctls(sysctls): { spec+: { executor+: { podSecurityContext+: { sysctls: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } },
        '#withSysctlsMixin':: d.fn(help='"Sysctls hold a list of namespaced sysctls used for the pod. Pods with unsupported\\nsysctls (by the container runtime) might fail to launch.\\nNote that this field cannot be set when spec.os.name is windows."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sysctls', type=d.T.array)]),
        withSysctlsMixin(sysctls): { spec+: { executor+: { podSecurityContext+: { sysctls+: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } },
      },
      '#ports':: d.obj(help='"Ports settings for the pods, following the Kubernetes specifications."'),
      ports: {
        '#withContainerPort':: d.fn(help='', args=[d.arg(name='containerPort', type=d.T.integer)]),
      ...
      securityContext: {
        ...
        appArmorProfile: {
          '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used.\\nThe profile must be preconfigured on the node to work.\\nMust match the loaded name of the profile.\\nMust be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
          withLocalhostProfile(localhostProfile): { spec+: { executor+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } } },
          '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied.\\nValid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { executor+: { securityContext+: { appArmorProfile+: { type: type } } } } },
        },
        '#capabilities':: d.obj(help='"The capabilities to add/drop when running containers.\\nDefaults to the default set of capabilities granted by the container runtime.\\nNote that this field cannot be set when spec.os.name is windows."'),
        capabilities: {
          '#withAdd':: d.fn(help='"Added capabilities"', args=[d.arg(name='add', type=d.T.array)]),
          withAdd(add): { spec+: { executor+: { securityContext+: { capabilities+: { add: if std.isArray(v=add) then add else [add] } } } } },
          '#withAddMixin':: d.fn(help='"Added capabilities"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='add', type=d.T.array)]),
          withAddMixin(add): { spec+: { executor+: { securityContext+: { capabilities+: { add+: if std.isArray(v=add) then add else [add] } } } } },
          '#withDrop':: d.fn(help='"Removed capabilities"', args=[d.arg(name='drop', type=d.T.array)]),
          withDrop(drop): { spec+: { executor+: { securityContext+: { capabilities+: { drop: if std.isArray(v=drop) then drop else [drop] } } } } },
          '#withDropMixin':: d.fn(help='"Removed capabilities"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='drop', type=d.T.array)]),
          withDropMixin(drop): { spec+: { executor+: { securityContext+: { capabilities+: { drop+: if std.isArray(v=drop) then drop else [drop] } } } } },
        },
        '#seLinuxOptions':: d.obj(help='"The SELinux context to be applied to the container.\\nIf unspecified, the container runtime will allocate a random SELinux context for each\\ncontainer.  May also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."'),
        seLinuxOptions: {
          '#withLevel':: d.fn(help='"Level is SELinux level label that applies to the container."', args=[d.arg(name='level', type=d.T.string)]),
          withLevel(level): { spec+: { executor+: { securityContext+: { seLinuxOptions+: { level: level } } } } },
          '#withRole':: d.fn(help='"Role is a SELinux role label that applies to the container."', args=[d.arg(name='role', type=d.T.string)]),
          withRole(role): { spec+: { executor+: { securityContext+: { seLinuxOptions+: { role: role } } } } },
          '#withType':: d.fn(help='"Type is a SELinux type label that applies to the container."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { executor+: { securityContext+: { seLinuxOptions+: { type: type } } } } },
          '#withUser':: d.fn(help='"User is a SELinux user label that applies to the container."', args=[d.arg(name='user', type=d.T.string)]),
          withUser(user): { spec+: { executor+: { securityContext+: { seLinuxOptions+: { user: user } } } } },
        },
        '#seccompProfile':: d.obj(help='"The seccomp options to use by this container. If seccomp options are\\nprovided at both the pod & container level, the container options\\noverride the pod options.\\nNote that this field cannot be set when spec.os.name is windows."'),
        seccompProfile: {
          '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used.\\nThe profile must be preconfigured on the node to work.\\nMust be a descending path, relative to the kubelet's configured seccomp profile location.\\nMust be set if type is \\\"Localhost\\\". Must NOT be set for any other type.\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
          withLocalhostProfile(localhostProfile): { spec+: { executor+: { securityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } } },
          '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied.\\nValid options are:\\n\\nLocalhost - a profile defined in a file on the node should be used.\\nRuntimeDefault - the container runtime default profile should be used.\\nUnconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { executor+: { securityContext+: { seccompProfile+: { type: type } } } } },
        },
        '#windowsOptions':: d.obj(help='"The Windows specific settings applied to all containers.\\nIf unspecified, the options from the PodSecurityContext will be used.\\nIf set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is linux."'),
        windowsOptions: {
          '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook\\n(https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the\\nGMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
          withGmsaCredentialSpec(gmsaCredentialSpec): { spec+: { executor+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } },
          '#withGmsaCredentialSpecName':: d.fn(help='"GMSACredentialSpecName is the name of the GMSA credential spec to use."', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
          withGmsaCredentialSpecName(gmsaCredentialSpecName): { spec+: { executor+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } },
          '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container.\\nAll of a Pod's containers must have the same effective HostProcess value\\n(it is not allowed to have a mix of HostProcess containers and non-HostProcess containers).\\nIn addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
          withHostProcess(hostProcess): { spec+: { executor+: { securityContext+: { windowsOptions+: { hostProcess: hostProcess } } } } },
          '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process.\\nDefaults to the user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext. If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
          withRunAsUserName(runAsUserName): { spec+: { executor+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } },
        },
        '#withAllowPrivilegeEscalation':: d.fn(help='"AllowPrivilegeEscalation controls whether a process can gain more\\nprivileges than its parent process. This bool directly controls if\\nthe no_new_privs flag will be set on the container process.\\nAllowPrivilegeEscalation is true always when the container is:\\n1) run as Privileged\\n2) has CAP_SYS_ADMIN\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='allowPrivilegeEscalation', type=d.T.boolean)]),
        withAllowPrivilegeEscalation(allowPrivilegeEscalation): { spec+: { executor+: { securityContext+: { allowPrivilegeEscalation: allowPrivilegeEscalation } } } },
        '#withPrivileged':: d.fn(help='"Run container in privileged mode.\\nProcesses in privileged containers are essentially equivalent to root on the host.\\nDefaults to false.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='privileged', type=d.T.boolean)]),
        withPrivileged(privileged): { spec+: { executor+: { securityContext+: { privileged: privileged } } } },
        '#withProcMount':: d.fn(help='"procMount denotes the type of proc mount to use for the containers.\\nThe default value is Default which uses the container runtime defaults for\\nreadonly paths and masked paths.\\nThis requires the ProcMountType feature flag to be enabled.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='procMount', type=d.T.string)]),
        withProcMount(procMount): { spec+: { executor+: { securityContext+: { procMount: procMount } } } },
        '#withReadOnlyRootFilesystem':: d.fn(help='"Whether this container has a read-only root filesystem.\\nDefault is false.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='readOnlyRootFilesystem', type=d.T.boolean)]),
        withReadOnlyRootFilesystem(readOnlyRootFilesystem): { spec+: { executor+: { securityContext+: { readOnlyRootFilesystem: readOnlyRootFilesystem } } } },
        '#withRunAsGroup':: d.fn(help='"The GID to run the entrypoint of the container process.\\nUses runtime default if unset.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsGroup', type=d.T.integer)]),
        withRunAsGroup(runAsGroup): { spec+: { executor+: { securityContext+: { runAsGroup: runAsGroup } } } },
        '#withRunAsNonRoot':: d.fn(help='"Indicates that the container must run as a non-root user.\\nIf true, the Kubelet will validate the image at runtime to ensure that it\\ndoes not run as UID 0 (root) and fail to start the container if it does.\\nIf unset or false, no such validation will be performed.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
        withRunAsNonRoot(runAsNonRoot): { spec+: { executor+: { securityContext+: { runAsNonRoot: runAsNonRoot } } } },
        '#withRunAsUser':: d.fn(help='"The UID to run the entrypoint of the container process.\\nDefaults to user specified in image metadata if unspecified.\\nMay also be set in PodSecurityContext.  If set in both SecurityContext and\\nPodSecurityContext, the value specified in SecurityContext takes precedence.\\nNote that this field cannot be set when spec.os.name is windows."', args=[d.arg(name='runAsUser', type=d.T.integer)]),
        withRunAsUser(runAsUser): { spec+: { executor+: { securityContext+: { runAsUser: runAsUser } } } },
      },
      '#sidecars':: d.obj(help='"Sidecars is a list of sidecar containers that run along side the main Spark container."'),
      sidecars: {
        '#env':: d.obj(help='"List of environment variables to set in the container.\\nCannot be updated."'),
      ...
      '#withAnnotations':: d.fn(help='"Annotations are the Kubernetes annotations to be added to the pod."', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotations(annotations): { spec+: { executor+: { annotations: annotations } } },
      '#withAnnotationsMixin':: d.fn(help='"Annotations are the Kubernetes annotations to be added to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotationsMixin(annotations): { spec+: { executor+: { annotations+: annotations } } },
      '#withConfigMaps':: d.fn(help='"ConfigMaps carries information of other ConfigMaps to add to the pod."', args=[d.arg(name='configMaps', type=d.T.array)]),
      withConfigMaps(configMaps): { spec+: { executor+: { configMaps: if std.isArray(v=configMaps) then configMaps else [configMaps] } } },
      '#withConfigMapsMixin':: d.fn(help='"ConfigMaps carries information of other ConfigMaps to add to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='configMaps', type=d.T.array)]),
      withConfigMapsMixin(configMaps): { spec+: { executor+: { configMaps+: if std.isArray(v=configMaps) then configMaps else [configMaps] } } },
      '#withCoreLimit':: d.fn(help='"CoreLimit specifies a hard limit on CPU cores for the pod.\\nOptional"', args=[d.arg(name='coreLimit', type=d.T.string)]),
      withCoreLimit(coreLimit): { spec+: { executor+: { coreLimit: coreLimit } } },
      ...
      withCoreRequest(coreRequest): { spec+: { executor+: { coreRequest: coreRequest } } },
      '#withCores':: d.fn(help='"Cores maps to `spark.driver.cores` or `spark.executor.cores` for the driver and executors, respectively."', args=[d.arg(name='cores', type=d.T.integer)]),
      withCores(cores): { spec+: { executor+: { cores: cores } } },
      ...
      withDeleteOnTermination(deleteOnTermination): { spec+: { executor+: { deleteOnTermination: deleteOnTermination } } },
      '#withEnv':: d.fn(help='"Env carries the environment variables to add to the pod."', args=[d.arg(name='env', type=d.T.array)]),
      withEnv(env): { spec+: { executor+: { env: if std.isArray(v=env) then env else [env] } } },
      '#withEnvFrom':: d.fn(help='"EnvFrom is a list of sources to populate environment variables in the container."', args=[d.arg(name='envFrom', type=d.T.array)]),
      withEnvFrom(envFrom): { spec+: { executor+: { envFrom: if std.isArray(v=envFrom) then envFrom else [envFrom] } } },
      '#withEnvFromMixin':: d.fn(help='"EnvFrom is a list of sources to populate environment variables in the container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envFrom', type=d.T.array)]),
      withEnvFromMixin(envFrom): { spec+: { executor+: { envFrom+: if std.isArray(v=envFrom) then envFrom else [envFrom] } } },
      '#withEnvMixin':: d.fn(help='"Env carries the environment variables to add to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='env', type=d.T.array)]),
      withEnvMixin(env): { spec+: { executor+: { env+: if std.isArray(v=env) then env else [env] } } },
      '#withEnvSecretKeyRefs':: d.fn(help='"EnvSecretKeyRefs holds a mapping from environment variable names to SecretKeyRefs.\\nDeprecated. Consider using `env` instead."', args=[d.arg(name='envSecretKeyRefs', type=d.T.object)]),
      withEnvSecretKeyRefs(envSecretKeyRefs): { spec+: { executor+: { envSecretKeyRefs: envSecretKeyRefs } } },
      '#withEnvSecretKeyRefsMixin':: d.fn(help='"EnvSecretKeyRefs holds a mapping from environment variable names to SecretKeyRefs.\\nDeprecated. Consider using `env` instead."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envSecretKeyRefs', type=d.T.object)]),
      withEnvSecretKeyRefsMixin(envSecretKeyRefs): { spec+: { executor+: { envSecretKeyRefs+: envSecretKeyRefs } } },
      '#withEnvVars':: d.fn(help='"EnvVars carries the environment variables to add to the pod.\\nDeprecated. Consider using `env` instead."', args=[d.arg(name='envVars', type=d.T.object)]),
      withEnvVars(envVars): { spec+: { executor+: { envVars: envVars } } },
      '#withEnvVarsMixin':: d.fn(help='"EnvVars carries the environment variables to add to the pod.\\nDeprecated. Consider using `env` instead."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='envVars', type=d.T.object)]),
      withEnvVarsMixin(envVars): { spec+: { executor+: { envVars+: envVars } } },
      '#withHostAliases':: d.fn(help='"HostAliases settings for the pod, following the Kubernetes specifications."', args=[d.arg(name='hostAliases', type=d.T.array)]),
      withHostAliases(hostAliases): { spec+: { executor+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } },
      '#withHostAliasesMixin':: d.fn(help='"HostAliases settings for the pod, following the Kubernetes specifications."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hostAliases', type=d.T.array)]),
      withHostAliasesMixin(hostAliases): { spec+: { executor+: { hostAliases+: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } },
      '#withHostNetwork':: d.fn(help='"HostNetwork indicates whether to request host networking for the pod or not."', args=[d.arg(name='hostNetwork', type=d.T.boolean)]),
      withHostNetwork(hostNetwork): { spec+: { executor+: { hostNetwork: hostNetwork } } },
      '#withImage':: d.fn(help='"Image is the container image to use. Overrides Spec.Image if set."', args=[d.arg(name='image', type=d.T.string)]),
      withImage(image): { spec+: { executor+: { image: image } } },
      '#withInitContainers':: d.fn(help='"InitContainers is a list of init-containers that run to completion before the main Spark container."', args=[d.arg(name='initContainers', type=d.T.array)]),
      withInitContainers(initContainers): { spec+: { executor+: { initContainers: if std.isArray(v=initContainers) then initContainers else [initContainers] } } },
      '#withInitContainersMixin':: d.fn(help='"InitContainers is a list of init-containers that run to completion before the main Spark container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='initContainers', type=d.T.array)]),
      withInitContainersMixin(initContainers): { spec+: { executor+: { initContainers+: if std.isArray(v=initContainers) then initContainers else [initContainers] } } },
      '#withInstances':: d.fn(help='"Instances is the number of executor instances."', args=[d.arg(name='instances', type=d.T.integer)]),
      withInstances(instances): { spec+: { executor+: { instances: instances } } },
      '#withJavaOptions':: d.fn(help='"JavaOptions is a string of extra JVM options to pass to the executors. For instance,\\nGC settings or other logging."', args=[d.arg(name='javaOptions', type=d.T.string)]),
      withJavaOptions(javaOptions): { spec+: { executor+: { javaOptions: javaOptions } } },
      '#withLabels':: d.fn(help='"Labels are the Kubernetes labels to be added to the pod."', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { spec+: { executor+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Labels are the Kubernetes labels to be added to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { spec+: { executor+: { labels+: labels } } },
      '#withMemory':: d.fn(help='"Memory is the amount of memory to request for the pod."', args=[d.arg(name='memory', type=d.T.string)]),
      withMemory(memory): { spec+: { executor+: { memory: memory } } },
      '#withMemoryLimit':: d.fn(help='"MemoryLimit overrides the memory limit of the pod."', args=[d.arg(name='memoryLimit', type=d.T.string)]),
      withMemoryLimit(memoryLimit): { spec+: { executor+: { memoryLimit: memoryLimit } } },
      '#withMemoryOverhead':: d.fn(help='"MemoryOverhead is the amount of off-heap memory to allocate in cluster mode, in MiB unless otherwise specified."', args=[d.arg(name='memoryOverhead', type=d.T.string)]),
      withMemoryOverhead(memoryOverhead): { spec+: { executor+: { memoryOverhead: memoryOverhead } } },
      '#withNodeSelector':: d.fn(help='"NodeSelector is the Kubernetes node selector to be added to the driver and executor pods.\\nThis field is mutually exclusive with nodeSelector at SparkApplication level (which will be deprecated)."', args=[d.arg(name='nodeSelector', type=d.T.object)]),
      withNodeSelector(nodeSelector): { spec+: { executor+: { nodeSelector: nodeSelector } } },
      '#withNodeSelectorMixin':: d.fn(help='"NodeSelector is the Kubernetes node selector to be added to the driver and executor pods.\\nThis field is mutually exclusive with nodeSelector at SparkApplication level (which will be deprecated)."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='nodeSelector', type=d.T.object)]),
      withNodeSelectorMixin(nodeSelector): { spec+: { executor+: { nodeSelector+: nodeSelector } } },
      '#withPorts':: d.fn(help='"Ports settings for the pods, following the Kubernetes specifications."', args=[d.arg(name='ports', type=d.T.array)]),
      withPorts(ports): { spec+: { executor+: { ports: if std.isArray(v=ports) then ports else [ports] } } },
      '#withPortsMixin':: d.fn(help='"Ports settings for the pods, following the Kubernetes specifications."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ports', type=d.T.array)]),
      withPortsMixin(ports): { spec+: { executor+: { ports+: if std.isArray(v=ports) then ports else [ports] } } },
      ...
      withPriorityClassName(priorityClassName): { spec+: { executor+: { priorityClassName: priorityClassName } } },
      '#withSchedulerName':: d.fn(help='"SchedulerName specifies the scheduler that will be used for scheduling"', args=[d.arg(name='schedulerName', type=d.T.string)]),
      withSchedulerName(schedulerName): { spec+: { executor+: { schedulerName: schedulerName } } },
      '#withSecrets':: d.fn(help='"Secrets carries information of secrets to add to the pod."', args=[d.arg(name='secrets', type=d.T.array)]),
      withSecrets(secrets): { spec+: { executor+: { secrets: if std.isArray(v=secrets) then secrets else [secrets] } } },
      '#withSecretsMixin':: d.fn(help='"Secrets carries information of secrets to add to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='secrets', type=d.T.array)]),
      withSecretsMixin(secrets): { spec+: { executor+: { secrets+: if std.isArray(v=secrets) then secrets else [secrets] } } },
      '#withServiceAccount':: d.fn(help='"ServiceAccount is the name of the custom Kubernetes service account used by the pod."', args=[d.arg(name='serviceAccount', type=d.T.string)]),
      withServiceAccount(serviceAccount): { spec+: { executor+: { serviceAccount: serviceAccount } } },
      '#withShareProcessNamespace':: d.fn(help='"ShareProcessNamespace settings for the pod, following the Kubernetes specifications."', args=[d.arg(name='shareProcessNamespace', type=d.T.boolean)]),
      withShareProcessNamespace(shareProcessNamespace): { spec+: { executor+: { shareProcessNamespace: shareProcessNamespace } } },
      '#withSidecars':: d.fn(help='"Sidecars is a list of sidecar containers that run along side the main Spark container."', args=[d.arg(name='sidecars', type=d.T.array)]),
      withSidecars(sidecars): { spec+: { executor+: { sidecars: if std.isArray(v=sidecars) then sidecars else [sidecars] } } },
      '#withSidecarsMixin':: d.fn(help='"Sidecars is a list of sidecar containers that run along side the main Spark container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='sidecars', type=d.T.array)]),
      withSidecarsMixin(sidecars): { spec+: { executor+: { sidecars+: if std.isArray(v=sidecars) then sidecars else [sidecars] } } },
      '#withTemplate':: d.fn(help='"Template is a pod template that can be used to define the driver or executor pod configurations that Spark configurations do not support.\\nSpark version >= 3.0.0 is required.\\nRef: https://spark.apache.org/docs/latest/running-on-kubernetes.html#pod-template."', args=[d.arg(name='template', type=d.T.object)]),
      withTemplate(template): { spec+: { executor+: { template: template } } },
      '#withTemplateMixin':: d.fn(help='"Template is a pod template that can be used to define the driver or executor pod configurations that Spark configurations do not support.\\nSpark version >= 3.0.0 is required.\\nRef: https://spark.apache.org/docs/latest/running-on-kubernetes.html#pod-template."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='template', type=d.T.object)]),
      withTemplateMixin(template): { spec+: { executor+: { template+: template } } },
      '#withTerminationGracePeriodSeconds':: d.fn(help='"Termination grace period seconds for the pod"', args=[d.arg(name='terminationGracePeriodSeconds', type=d.T.integer)]),
      withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { spec+: { executor+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } },
      '#withTolerations':: d.fn(help='"Tolerations specifies the tolerations listed in \\".spec.tolerations\\" to be applied to the pod."', args=[d.arg(name='tolerations', type=d.T.array)]),
      withTolerations(tolerations): { spec+: { executor+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } } },
      '#withTolerationsMixin':: d.fn(help='"Tolerations specifies the tolerations listed in \\".spec.tolerations\\" to be applied to the pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tolerations', type=d.T.array)]),
      withTolerationsMixin(tolerations): { spec+: { executor+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } } },
      '#withVolumeMounts':: d.fn(help="\"VolumeMounts specifies the volumes listed in \\\".spec.volumes\\\" to mount into the main container's filesystem.\"", args=[d.arg(name='volumeMounts', type=d.T.array)]),
      withVolumeMounts(volumeMounts): { spec+: { executor+: { volumeMounts: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
      '#withVolumeMountsMixin':: d.fn(help="\"VolumeMounts specifies the volumes listed in \\\".spec.volumes\\\" to mount into the main container's filesystem.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='volumeMounts', type=d.T.array)]),
      withVolumeMountsMixin(volumeMounts): { spec+: { executor+: { volumeMounts+: if std.isArray(v=volumeMounts) then volumeMounts else [volumeMounts] } } },
    },
    ...
    monitoring: {
      ...
      prometheus: {
        ...
        withConfigFile(configFile): { spec+: { monitoring+: { prometheus+: { configFile: configFile } } } },
        ...
        withConfiguration(configuration): { spec+: { monitoring+: { prometheus+: { configuration: configuration } } } },
        ...
        withJmxExporterJar(jmxExporterJar): { spec+: { monitoring+: { prometheus+: { jmxExporterJar: jmxExporterJar } } } },
        ...
        withPort(port): { spec+: { monitoring+: { prometheus+: { port: port } } } },
        ...
        withPortName(portName): { spec+: { monitoring+: { prometheus+: { portName: portName } } } },
      },
      ...
      withExposeDriverMetrics(exposeDriverMetrics): { spec+: { monitoring+: { exposeDriverMetrics: exposeDriverMetrics } } },
      ...
      withExposeExecutorMetrics(exposeExecutorMetrics): { spec+: { monitoring+: { exposeExecutorMetrics: exposeExecutorMetrics } } },
      ...
      withMetricsProperties(metricsProperties): { spec+: { monitoring+: { metricsProperties: metricsProperties } } },
      ...
      withMetricsPropertiesFile(metricsPropertiesFile): { spec+: { monitoring+: { metricsPropertiesFile: metricsPropertiesFile } } },
    },
    ...
    restartPolicy: {
      ...
      withOnFailureRetries(onFailureRetries): { spec+: { restartPolicy+: { onFailureRetries: onFailureRetries } } },
      ...
      withOnFailureRetryInterval(onFailureRetryInterval): { spec+: { restartPolicy+: { onFailureRetryInterval: onFailureRetryInterval } } },
      ...
      withOnSubmissionFailureRetries(onSubmissionFailureRetries): { spec+: { restartPolicy+: { onSubmissionFailureRetries: onSubmissionFailureRetries } } },
      ...
      withOnSubmissionFailureRetryInterval(onSubmissionFailureRetryInterval): { spec+: { restartPolicy+: { onSubmissionFailureRetryInterval: onSubmissionFailureRetryInterval } } },
      '#withType':: d.fn(help='"Type specifies the RestartPolicyType."', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { spec+: { restartPolicy+: { type: type } } },
    },
    ...
    sparkUIOptions: {
      ...
      '#withIngressAnnotations':: d.fn(help='"IngressAnnotations is a map of key,value pairs of annotations that might be added to the ingress object. i.e. specify nginx as ingress.class"', args=[d.arg(name='ingressAnnotations', type=d.T.object)]),
      withIngressAnnotations(ingressAnnotations): { spec+: { sparkUIOptions+: { ingressAnnotations: ingressAnnotations } } },
      '#withIngressAnnotationsMixin':: d.fn(help='"IngressAnnotations is a map of key,value pairs of annotations that might be added to the ingress object. i.e. specify nginx as ingress.class"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ingressAnnotations', type=d.T.object)]),
      withIngressAnnotationsMixin(ingressAnnotations): { spec+: { sparkUIOptions+: { ingressAnnotations+: ingressAnnotations } } },
      '#withIngressTLS':: d.fn(help='"TlsHosts is useful If we need to declare SSL certificates to the ingress object"', args=[d.arg(name='ingressTLS', type=d.T.array)]),
      withIngressTLS(ingressTLS): { spec+: { sparkUIOptions+: { ingressTLS: if std.isArray(v=ingressTLS) then ingressTLS else [ingressTLS] } } },
      '#withIngressTLSMixin':: d.fn(help='"TlsHosts is useful If we need to declare SSL certificates to the ingress object"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ingressTLS', type=d.T.array)]),
      withIngressTLSMixin(ingressTLS): { spec+: { sparkUIOptions+: { ingressTLS+: if std.isArray(v=ingressTLS) then ingressTLS else [ingressTLS] } } },
      '#withServiceAnnotations':: d.fn(help='"ServiceAnnotations is a map of key,value pairs of annotations that might be added to the service object."', args=[d.arg(name='serviceAnnotations', type=d.T.object)]),
      withServiceAnnotations(serviceAnnotations): { spec+: { sparkUIOptions+: { serviceAnnotations: serviceAnnotations } } },
      '#withServiceAnnotationsMixin':: d.fn(help='"ServiceAnnotations is a map of key,value pairs of annotations that might be added to the service object."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceAnnotations', type=d.T.object)]),
      withServiceAnnotationsMixin(serviceAnnotations): { spec+: { sparkUIOptions+: { serviceAnnotations+: serviceAnnotations } } },
      '#withServiceLabels':: d.fn(help='"ServiceLabels is a map of key,value pairs of labels that might be added to the service object."', args=[d.arg(name='serviceLabels', type=d.T.object)]),
      withServiceLabels(serviceLabels): { spec+: { sparkUIOptions+: { serviceLabels: serviceLabels } } },
      '#withServiceLabelsMixin':: d.fn(help='"ServiceLabels is a map of key,value pairs of labels that might be added to the service object."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceLabels', type=d.T.object)]),
      withServiceLabelsMixin(serviceLabels): { spec+: { sparkUIOptions+: { serviceLabels+: serviceLabels } } },
      ...
      withServicePort(servicePort): { spec+: { sparkUIOptions+: { servicePort: servicePort } } },
      ...
      withServicePortName(servicePortName): { spec+: { sparkUIOptions+: { servicePortName: servicePortName } } },
      '#withServiceType':: d.fn(help='"ServiceType allows configuring the type of the service. Defaults to ClusterIP."', args=[d.arg(name='serviceType', type=d.T.string)]),
      withServiceType(serviceType): { spec+: { sparkUIOptions+: { serviceType: serviceType } } },
    },
    ...
    withBatchScheduler(batchScheduler): { spec+: { batchScheduler: batchScheduler } },
    ...
    withDriverIngressOptions(driverIngressOptions): { spec+: { driverIngressOptions: if std.isArray(v=driverIngressOptions) then driverIngressOptions else [driverIngressOptions] } },
    ...
    withDriverIngressOptionsMixin(driverIngressOptions): { spec+: { driverIngressOptions+: if std.isArray(v=driverIngressOptions) then driverIngressOptions else [driverIngressOptions] } },
    ...
    withFailureRetries(failureRetries): { spec+: { failureRetries: failureRetries } },
    ...
    withHadoopConf(hadoopConf): { spec+: { hadoopConf: hadoopConf } },
    ...
    withHadoopConfMixin(hadoopConf): { spec+: { hadoopConf+: hadoopConf } },
    ...
    withHadoopConfigMap(hadoopConfigMap): { spec+: { hadoopConfigMap: hadoopConfigMap } },
    ...
    withMainApplicationFile(mainApplicationFile): { spec+: { mainApplicationFile: mainApplicationFile } },
    ...
    withMainClass(mainClass): { spec+: { mainClass: mainClass } },
    ...
    withMemoryOverheadFactor(memoryOverheadFactor): { spec+: { memoryOverheadFactor: memoryOverheadFactor } },
    ...
    withProxyUser(proxyUser): { spec+: { proxyUser: proxyUser } },
    ...
    withPythonVersion(pythonVersion): { spec+: { pythonVersion: pythonVersion } },
    ...
    withSparkConf(sparkConf): { spec+: { sparkConf: sparkConf } },
    ...
    withSparkConfMixin(sparkConf): { spec+: { sparkConf+: sparkConf } },
    ...
    withSparkConfigMap(sparkConfigMap): { spec+: { sparkConfigMap: sparkConfigMap } },
    ...
    withSparkVersion(sparkVersion): { spec+: { sparkVersion: sparkVersion } },
    ...
    withTimeToLiveSeconds(timeToLiveSeconds): { spec+: { timeToLiveSeconds: timeToLiveSeconds } },
